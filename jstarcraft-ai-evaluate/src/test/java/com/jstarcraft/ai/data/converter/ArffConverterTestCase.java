...
public class ArffConverterTestCase {
    ...
    public void testConvert() throws Exception {
        ...
        ArffConverter converter = new ArffConverter(space.getQualityAttributes(), space.getQuantityAttributes());
        {
            ...
            File file = new File(this.getClass().getResource("dense.arff").toURI());
        ...
        }
        {
            ...
            File file = new File(this.getClass().getResource("sparse.arff").toURI());
            InputStream stream = new FileInputStream(file);
