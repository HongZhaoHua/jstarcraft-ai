package com.jstarcraft.ai.neuralnetwork.vertex.normalization;
...
public class L2NormalizeVertex extends BaseGraphVertex {
	...
	public L2NormalizeVertex(ComputationGraph graph, String name, int vertexIndex, VertexIndices[] inputVertices, VertexIndices[] outputVertices, int[] dimension, double eps) {
	...
	public INDArray doForward(boolean training) {
		if (!canDoForward())
			throw new IllegalStateException("Cannot do forward pass: inputs not set (L2NormalizeVertex " + vertexName + " idx " + vertexIndex + ")");
