...
import com.jstarcraft.ai.jsat.distributions.discrete.Poisson;
...
public class PoissonTest {
    ...
    public void testLogPmf() {
        ...
        double[] expected_7 = new double[] { -7.00000000000000, -5.05408985094469, -3.80132688244932, -2.95402902206212, -2.39441323412669, -2.05794099750548, -1.90379031767822, -1.90379031767822, -2.03732171030274, -2.28863613858365, -2.64531108252238 };
    ...
    public void testPmf() {
        ...
        double[] expected_7 = new double[] { 0.000911881965554516, 0.00638317375888161, 0.0223411081560856, 0.0521292523641998, 0.0912261916373497, 0.127716668292290, 0.149002779674338, 0.149002779674338, 0.130377432215046, 0.101404669500591, 0.0709832686504137 };
    ...
    public void testCdf() {
        ...
        double[] expected_7 = new double[] { 0.000911881965554516, 0.00729505572443613, 0.0296361638805218, 0.0817654162447216, 0.172991607882071, 0.300708276174361, 0.449711055848699, 0.598713835523037, 0.729091267738082, 0.830495937238673, 0.901479205889087 };

        for (int i = 0; i < expected_7.length; i++) {
            assertEquals(expected_7[i], instance.cdf(testVals[i]), 1e-4);

            // its hard to get the right value for the probabilities right on the line, so
            // lets nudge them a little to make sure we map to the right spot
            double val;
            if (i == 0)
    ...
    public void testSample() {
         ...
         * theoretical variance and in the case of Poisson, larger than its mean. This
         * is known as overdispersion, an important concept that occurs with discrete
         * data"
         */
