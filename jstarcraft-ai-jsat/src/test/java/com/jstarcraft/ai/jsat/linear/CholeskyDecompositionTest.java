...
public class CholeskyDecompositionTest {
    ...
    @Before
    public void setUp() {
        pascal5 = new DenseMatrix(new double[][] { { 1, 1, 1, 1, 1 }, { 1, 2, 3, 4, 5 }, { 1, 3, 6, 10, 15 }, { 1, 4, 10, 20, 35 }, { 1, 5, 15, 35, 70 } });
    ...
    public void testGetL() {
        Matrix p5L = new DenseMatrix(new double[][] { { 1, 1, 1, 1, 1 }, { 0, 1, 2, 3, 4 }, { 0, 0, 1, 3, 6 }, { 0, 0, 0, 1, 4 }, { 0, 0, 0, 0, 1 } });

        Matrix p4L = new DenseMatrix(new double[][] { { 1, 1, 1, 1 }, { 0, 1, 2, 3 }, { 0, 0, 1, 3 }, { 0, 0, 0, 1 } });
    ...
    public void testSolveMatrix() {
        Matrix B5 = new DenseMatrix(new double[][] { { 2, 3, 5 }, { 1, 7, 1 }, { 4, 5, 5 }, { 3, 9, 1 }, { 2, 3, 8 } });

        Matrix B4 = new DenseMatrix(new double[][] { { 4, 7, 6 }, { 3, 3, 5 }, { 5, 7, 3 }, { 7, 4, 6 }, });
        Matrix X5 = new DenseMatrix(new double[][] { { 27, -47, 68 }, { -81, 164, -208 }, { 100, -210, 266 }, { -56, 124, -156 }, { 12, -28, 35 } });

        Matrix X4 = new DenseMatrix(new double[][] { { 11, 34, 0 }, { -16, -65, 19 }, { 12, 53, -19 }, { -3, -15, 6 }, });
