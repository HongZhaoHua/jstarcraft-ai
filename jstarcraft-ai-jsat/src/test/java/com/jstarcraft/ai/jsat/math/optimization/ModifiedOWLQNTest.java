...
import com.jstarcraft.ai.jsat.math.optimization.ModifiedOWLQN;
...
public class ModifiedOWLQNTest {
    ...
    public void testOptimizeReg() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            Vec v = DenseVector.toDenseVec(Z1 + rand.nextGaussian() / 10, -Z1 + rand.nextGaussian() / 10, Z1 + rand.nextGaussian() / 10,

                    -Z2 + rand.nextGaussian() / 10, Z2 + rand.nextGaussian() / 10, -Z2 + rand.nextGaussian() / 10);
