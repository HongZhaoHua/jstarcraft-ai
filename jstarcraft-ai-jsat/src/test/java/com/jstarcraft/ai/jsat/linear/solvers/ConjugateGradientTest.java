...
import com.jstarcraft.ai.jsat.linear.solvers.ConjugateGradient;
...
public class ConjugateGradientTest {
    ...
    public void testSolve_4args() {
        ...
        A = new DenseMatrix(new double[][] { { 1, 1, 1, 1, 1 }, { 1, 8, 1, 8, 1 }, { 1, 1, 27, 1, 1 }, { 1, 8, 1, 64, 1 }, { 1, 1, 1, 1, 125 } });
    ...
    public void testSolveCGNR_4args() {
        ...
        DenseMatrix A = new DenseMatrix(new double[][] { { 9, 3, 9, 5, 9, 6, 9, 3 }, { 10, 8, 3, 4, 3, 1, 1, 2 }, { 5, 3, 2, 8, 8, 1, 6, 8 }, { 1, 8, 3, 6, 8, 5, 5, 3 }, { 1, 2, 6, 5, 4, 8, 0, 5 }, });
        ...
        A = new DenseMatrix(new double[][] { { 4, 8, 8, 1 }, { 1, 9, 4, 1 }, { 10, 1, 9, 9 }, { 0, 4, 2, 6 }, { 8, 3, 3, 5 }, });
    ...
    public void testSolve_5args() {
        ...
        // Test for a 5x5 matrix symmetric positive definite
        DenseMatrix A = new DenseMatrix(new double[][] { { 1, 1, 1, 1, 1 }, { 1, 8, 1, 8, 1 }, { 1, 1, 27, 1, 1 }, { 1, 8, 1, 64, 1 }, { 1, 1, 1, 1, 125 } });

        DenseVector b = DenseVector.toDenseVec(1, 4, 3, 5, 2);

        DenseMatrix Minv = new DenseMatrix(new double[][] { { 1.0000, 0, 0, 0, 0 }, { 0, 0.1250, 0, 0, 0 }, { 0, 0, 0.0370, 0, 0 }, { 0, 0, 0, 0.0156, 0 }, { 0, 0, 0, 0, 0.0080 }, });
