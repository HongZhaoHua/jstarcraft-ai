...
import com.jstarcraft.ai.jsat.distributions.MaxwellBoltzmann;
...
public class MaxwellBoltzmannTest {
    ...
    public void testMode() {
        ...
        dist = new MaxwellBoltzmann(12);
        assertEquals(16.970562749522642, dist.mode(), 1e-8);// Hitting the bounds of what we can numericaly caluate well. But relative error
                                                            // is still in 1e-10
    }
