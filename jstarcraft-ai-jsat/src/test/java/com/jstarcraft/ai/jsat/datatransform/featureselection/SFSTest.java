...
public class SFSTest {
     ...
     * @param t0   the true index in the 10 dimensional space to place the first
     *             value
     * @param t1   the true index in the 10 dimensional space to place the second
     *             value
     * @param t2   the true index in the 10 dimensional space to place the third
     *             value
     */
    public static ClassificationDataSet generate3DimIn10(Random rand, int t0, int t1, int t2) {
        ClassificationDataSet cds = new ClassificationDataSet(10, new CategoricalData[0], new CategoricalData(4));
        int cSize = 40;
    ...
    public static RegressionDataSet generate3DimIn10R(Random rand, int t0, int t1, int t2) {
