...
import com.jstarcraft.ai.jsat.datatransform.FastICA;
import com.jstarcraft.ai.jsat.datatransform.InverseOfTransform;
import com.jstarcraft.ai.jsat.datatransform.LinearTransform;
import com.jstarcraft.ai.jsat.datatransform.WhitenedPCA;
import com.jstarcraft.ai.jsat.datatransform.ZeroMeanTransform;
...
public class FastICATest {
    ...
    public void testTransform2_2() {
        ...
        Matrix mixing_true = new DenseMatrix(new double[][] { { 2, -1.5 }, { 0.5, 0 } });
        ...
        // make sure scales match up. Keep 0 as the axis around which the sign changes
        // so comparisons work when ICA acidently gest the wrong sign
        ...
        // Lets go through and comapre our found components to truth. Check differnces
        // in absolute value, becasue the independent compontents may have the wrong
        // sign!
    ...
    public void testTransform2_2_prewhite() {
        ...
        Matrix mixing_true = new DenseMatrix(new double[][] { { 2, -1.5 }, { 0.5, 1 } });
    ...
    public void testTransform2_3() {
        ...
        Matrix mixing_true = new DenseMatrix(new double[][] { { 2, 1.5, -1 }, { -0.5, 1, 2 }, });
