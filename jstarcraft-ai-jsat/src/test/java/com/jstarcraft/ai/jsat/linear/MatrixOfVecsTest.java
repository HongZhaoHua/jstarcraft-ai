...
public class MatrixOfVecsTest {
    ...
    public static void setUpClass() {
        A = new MatrixOfVecs(new Vec[] { DenseVector.toDenseVec(1, 5, 4, 8, 9), DenseVector.toDenseVec(1, 5, 7, 3, 7), DenseVector.toDenseVec(0, 3, 8, 5, 6), DenseVector.toDenseVec(3, 8, 0, 7, 0), DenseVector.toDenseVec(1, 9, 2, 9, 6) });

        B = new MatrixOfVecs(new Vec[] { DenseVector.toDenseVec(5, 3, 2, 8, 8), DenseVector.toDenseVec(1, 8, 3, 6, 8), DenseVector.toDenseVec(1, 2, 6, 5, 4), DenseVector.toDenseVec(3, 9, 5, 9, 6), DenseVector.toDenseVec(8, 3, 4, 3, 1) });

        C = new MatrixOfVecs(new Vec[] { DenseVector.toDenseVec(1, 6, 8, 3, 1, 5, 10), DenseVector.toDenseVec(5, 5, 3, 7, 2, 10, 0), DenseVector.toDenseVec(8, 0, 5, 7, 9, 1, 8), DenseVector.toDenseVec(9, 3, 2, 7, 2, 4, 8), DenseVector.toDenseVec(1, 2, 6, 5, 8, 1, 9) });

        AB = new MatrixOfVecs(new Vec[] { DenseVector.toDenseVec(110, 150, 117, 157, 121), DenseVector.toDenseVec(82, 105, 102, 121, 101), DenseVector.toDenseVec(74, 103, 106, 121, 92), DenseVector.toDenseVec(44, 136, 65, 135, 130), DenseVector.toDenseVec(91, 178, 110, 171, 148) });

        BA = new MatrixOfVecs(new Vec[] { DenseVector.toDenseVec(40, 182, 73, 187, 126), DenseVector.toDenseVec(35, 174, 100, 161, 131), DenseVector.toDenseVec(22, 109, 74, 115, 83), DenseVector.toDenseVec(45, 201, 127, 193, 156), DenseVector.toDenseVec(21, 100, 87, 123, 123) });

        AC = new MatrixOfVecs(new Vec[] { DenseVector.toDenseVec(139, 73, 113, 167, 135, 100, 187), DenseVector.toDenseVec(116, 54, 106, 143, 136, 81, 153), DenseVector.toDenseVec(130, 42, 95, 142, 136, 64, 158), DenseVector.toDenseVec(106, 79, 62, 114, 33, 123, 86), DenseVector.toDenseVec(149, 90, 99, 173, 103, 139, 152) });
    }
    ...
    public void testMutableAdd_Matrix() {
        DenseMatrix ApB = new DenseMatrix(new double[][] { { 6, 8, 6, 16, 17 }, { 2, 13, 10, 9, 15 }, { 1, 5, 14, 10, 10 }, { 6, 17, 5, 16, 6 }, { 9, 12, 6, 12, 7 } });
    ...
    public void testMutableAdd_double() {
        DenseMatrix ApTwo = new DenseMatrix(new double[][] { { 1 + 2, 5 + 2, 4 + 2, 8 + 2, 9 + 2 }, { 1 + 2, 5 + 2, 7 + 2, 3 + 2, 7 + 2 }, { 0 + 2, 3 + 2, 8 + 2, 5 + 2, 6 + 2 }, { 3 + 2, 8 + 2, 0 + 2, 7 + 2, 0 + 2 }, { 1 + 2, 9 + 2, 2 + 2, 9 + 2, 6 + 2 } });
    ...
    public void testMutableSubtract_Matrix() {
        DenseMatrix AmB = new DenseMatrix(new double[][] { { -4, 2, 2, 0, 1 }, { 0, -3, 4, -3, -1 }, { -1, 1, 2, 0, 2 }, { 0, -1, -5, -2, -6 }, { -7, 6, -2, 6, 5 } });

        DenseMatrix BmA = new DenseMatrix(new double[][] { { -4 * -1, 2 * -1, 2 * -1, 0 * -1, 1 * -1 }, { 0 * -1, -3 * -1, 4 * -1, -3 * -1, -1 * -1 }, { -1 * -1, 1 * -1, 2 * -1, 0 * -1, 2 * -1 }, { 0 * -1, -1 * -1, -5 * -1, -2 * -1, -6 * -1 }, { -7 * -1, 6 * -1, -2 * -1, 6 * -1, 5 * -1 } });
    ...
    public void testMutableMultiply_double() {
        DenseMatrix AtTwo = new DenseMatrix(new double[][] { { 1 * 2, 5 * 2, 4 * 2, 8 * 2, 9 * 2 }, { 1 * 2, 5 * 2, 7 * 2, 3 * 2, 7 * 2 }, { 0 * 2, 3 * 2, 8 * 2, 5 * 2, 6 * 2 }, { 3 * 2, 8 * 2, 0 * 2, 7 * 2, 0 * 2 }, { 1 * 2, 9 * 2, 2 * 2, 9 * 2, 6 * 2 } });
    ...
    public void testTranspose() {
        DenseMatrix CTranspose = new DenseMatrix(new double[][] { { 1, 5, 8, 9, 1 }, { 6, 5, 0, 3, 2 }, { 8, 3, 5, 2, 6 }, { 3, 7, 7, 7, 5 }, { 1, 2, 9, 2, 8 }, { 5, 10, 1, 4, 1 }, { 10, 0, 8, 8, 9 } });
    ...
    public void testSwapRows() {
        ...
        Matrix Expected = new DenseMatrix(new double[][] { { 5, 5, 3, 7, 2, 10, 0 }, { 1, 2, 6, 5, 8, 1, 9 }, { 8, 0, 5, 7, 9, 1, 8 }, { 9, 3, 2, 7, 2, 4, 8 }, { 1, 6, 8, 3, 1, 5, 10 } });
    ...
    public void testMutableTranspose() {
        ...
        DenseMatrix ATranspose = new DenseMatrix(new double[][] { { 1, 1, 0, 3, 1 }, { 5, 5, 3, 8, 9 }, { 4, 7, 8, 0, 2 }, { 8, 3, 5, 7, 9 }, { 9, 7, 6, 0, 6 }, });
    ...
    public void testTransposeMultiply_Matrix() {
        ...
        assertEquals(new DenseMatrix(new double[][] { { 34, 135, 105, 135, 98 }, { 22, 97, 63, 102, 101 }, { 23, 140, 105, 166, 159 }, { 36, 172, 127, 174, 148 }, { 17, 130, 106, 145, 125 }, { 28, 119, 100, 112, 127 }, { 43, 219, 122, 257, 192 }, }), result);

        result = C.transposeMultiply(C);
        assertEquals(new DenseMatrix(new double[][] { { 172, 60, 87, 162, 109, 100, 155 }, { 60, 74, 81, 84, 38, 94, 102 }, { 87, 81, 138, 124, 111, 89, 190 }, { 162, 84, 124, 181, 134, 125, 187 }, { 109, 38, 111, 134, 154, 50, 170 }, { 100, 94, 89, 125, 50, 143, 99 }, { 155, 102, 190, 187, 170, 99, 309 }, }), result);
    ...
    public void testTransposeMultiply_Matrix_Matrix() {
        ...
        Matrix CtA = new DenseMatrix(new double[][] { { 34, 135, 105, 135, 98 }, { 22, 97, 63, 102, 101 }, { 23, 140, 105, 166, 159 }, { 36, 172, 127, 174, 148 }, { 17, 130, 106, 145, 125 }, { 28, 119, 100, 112, 127 }, { 43, 219, 122, 257, 192 }, });
        assertEquals(CtA, R);
        C.transposeMultiply(A, R);
        ...
        Matrix CtC = new DenseMatrix(new double[][] { { 172, 60, 87, 162, 109, 100, 155 }, { 60, 74, 81, 84, 38, 94, 102 }, { 87, 81, 138, 124, 111, 89, 190 }, { 162, 84, 124, 181, 134, 125, 187 }, { 109, 38, 111, 134, 154, 50, 170 }, { 100, 94, 89, 125, 50, 143, 99 }, { 155, 102, 190, 187, 170, 99, 309 }, });
        assertEquals(CtC, R);
        C.transposeMultiply(C, R);
