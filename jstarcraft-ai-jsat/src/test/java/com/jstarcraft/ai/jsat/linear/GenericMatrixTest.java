...
import com.jstarcraft.ai.jsat.linear.GenericMatrix;
...
public class GenericMatrixTest {
    ...
    public static void setUpClass() throws Exception {
        A = new TestImp(new double[][] { { 1, 5, 4, 8, 9 }, { 1, 5, 7, 3, 7 }, { 0, 3, 8, 5, 6 }, { 3, 8, 0, 7, 0 }, { 1, 9, 2, 9, 6 } });

        B = new TestImp(new double[][] { { 5, 3, 2, 8, 8 }, { 1, 8, 3, 6, 8 }, { 1, 2, 6, 5, 4 }, { 3, 9, 5, 9, 6 }, { 8, 3, 4, 3, 1 } });

        C = new TestImp(new double[][] { { 1, 6, 8, 3, 1, 5, 10 }, { 5, 5, 3, 7, 2, 10, 0 }, { 8, 0, 5, 7, 9, 1, 8 }, { 9, 3, 2, 7, 2, 4, 8 }, { 1, 2, 6, 5, 8, 1, 9 } });

        D = new TestImp(new double[][] { { 2, 4, 5, 4, 4 }, { 10, 3, 2, 0, 7 }, { 4, 5, 1, 7, 7 }, { 2, 7, 2, 4, 7 }, { 6, 2, 9, 2, 4 }, { 1, 5, 6, 5, 10 }, { 3, 4, 1, 5, 0 }, });

        AB = new TestImp(new double[][] { { 110, 150, 117, 157, 121 }, { 82, 105, 102, 121, 101 }, { 74, 103, 106, 121, 92 }, { 44, 136, 65, 135, 130 }, { 91, 178, 110, 171, 148 } });

        BA = new TestImp(new double[][] { { 40, 182, 73, 187, 126 }, { 35, 174, 100, 161, 131 }, { 22, 109, 74, 115, 83 }, { 45, 201, 127, 193, 156 }, { 21, 100, 87, 123, 123 } });

        AC = new TestImp(new double[][] { { 139, 73, 113, 167, 135, 100, 187 }, { 116, 54, 106, 143, 136, 81, 153 }, { 130, 42, 95, 142, 136, 64, 158 }, { 106, 79, 62, 114, 33, 123, 86 }, { 149, 90, 99, 173, 103, 139, 152 } });
    ...
    public void testMutableAdd_Matrix() {
        TestImp ApB = new TestImp(new double[][] { { 6, 8, 6, 16, 17 }, { 2, 13, 10, 9, 15 }, { 1, 5, 14, 10, 10 }, { 6, 17, 5, 16, 6 }, { 9, 12, 6, 12, 7 } });
    ...
    public void testMutableAdd_double() {
        TestImp ApTwo = new TestImp(new double[][] { { 1 + 2, 5 + 2, 4 + 2, 8 + 2, 9 + 2 }, { 1 + 2, 5 + 2, 7 + 2, 3 + 2, 7 + 2 }, { 0 + 2, 3 + 2, 8 + 2, 5 + 2, 6 + 2 }, { 3 + 2, 8 + 2, 0 + 2, 7 + 2, 0 + 2 }, { 1 + 2, 9 + 2, 2 + 2, 9 + 2, 6 + 2 } });
    ...
    public void testMutableSubtract_Matrix() {
        TestImp AmB = new TestImp(new double[][] { { -4, 2, 2, 0, 1 }, { 0, -3, 4, -3, -1 }, { -1, 1, 2, 0, 2 }, { 0, -1, -5, -2, -6 }, { -7, 6, -2, 6, 5 } });

        TestImp BmA = new TestImp(new double[][] { { -4 * -1, 2 * -1, 2 * -1, 0 * -1, 1 * -1 }, { 0 * -1, -3 * -1, 4 * -1, -3 * -1, -1 * -1 }, { -1 * -1, 1 * -1, 2 * -1, 0 * -1, 2 * -1 }, { 0 * -1, -1 * -1, -5 * -1, -2 * -1, -6 * -1 }, { -7 * -1, 6 * -1, -2 * -1, 6 * -1, 5 * -1 } });
    ...
    public void testMultiplyTranspose_Matrix_Matrix() {
        TestImp AmBt = new TestImp(new double[][] { { 164, 173, 111, 194, 72 }, { 114, 136, 96, 152, 67 }, { 113, 126, 103, 148, 62 }, { 95, 109, 54, 144, 69 }, { 156, 181, 100, 211, 76 } });
        TestImp DmBt = new TestImp(new double[][] { { 96, 105, 76, 127, 64 }, { 119, 96, 56, 109, 104 }, { 149, 145, 83, 167, 79 }, { 123, 144, 76, 157, 64 }, { 102, 93, 90, 123, 100 }, { 152, 169, 112, 183, 72 }, { 69, 68, 42, 95, 55 }, });
    ...
    public void testMutableMultiply_double() {
        TestImp AtTwo = new TestImp(new double[][] { { 1 * 2, 5 * 2, 4 * 2, 8 * 2, 9 * 2 }, { 1 * 2, 5 * 2, 7 * 2, 3 * 2, 7 * 2 }, { 0 * 2, 3 * 2, 8 * 2, 5 * 2, 6 * 2 }, { 3 * 2, 8 * 2, 0 * 2, 7 * 2, 0 * 2 }, { 1 * 2, 9 * 2, 2 * 2, 9 * 2, 6 * 2 } });
    ...
    public void testTranspose() {
        TestImp CTranspose = new TestImp(new double[][] { { 1, 5, 8, 9, 1 }, { 6, 5, 0, 3, 2 }, { 8, 3, 5, 2, 6 }, { 3, 7, 7, 7, 5 }, { 1, 2, 9, 2, 8 }, { 5, 10, 1, 4, 1 }, { 10, 0, 8, 8, 9 } });
    ...
    public void testSwapRows() {
        ...
        Matrix Expected = new TestImp(new double[][] { { 5, 5, 3, 7, 2, 10, 0 }, { 1, 2, 6, 5, 8, 1, 9 }, { 8, 0, 5, 7, 9, 1, 8 }, { 9, 3, 2, 7, 2, 4, 8 }, { 1, 6, 8, 3, 1, 5, 10 } });
    ...
    public void testMutableTranspose() {
        ...
        TestImp ATranspose = new TestImp(new double[][] { { 1, 1, 0, 3, 1 }, { 5, 5, 3, 8, 9 }, { 4, 7, 8, 0, 2 }, { 8, 3, 5, 7, 9 }, { 9, 7, 6, 0, 6 }, });
    ...
    public void testTransposeMultiply_Matrix() {
        ...
        assertEquals(new TestImp(new double[][] { { 34, 135, 105, 135, 98 }, { 22, 97, 63, 102, 101 }, { 23, 140, 105, 166, 159 }, { 36, 172, 127, 174, 148 }, { 17, 130, 106, 145, 125 }, { 28, 119, 100, 112, 127 }, { 43, 219, 122, 257, 192 }, }), result);

        result = C.transposeMultiply(C);
        assertEquals(new TestImp(new double[][] { { 172, 60, 87, 162, 109, 100, 155 }, { 60, 74, 81, 84, 38, 94, 102 }, { 87, 81, 138, 124, 111, 89, 190 }, { 162, 84, 124, 181, 134, 125, 187 }, { 109, 38, 111, 134, 154, 50, 170 }, { 100, 94, 89, 125, 50, 143, 99 }, { 155, 102, 190, 187, 170, 99, 309 }, }), result);
    ...
    public void testTransposeMultiply_Matrix_Matrix() {
        ...
        Matrix CtA = new TestImp(new double[][] { { 34, 135, 105, 135, 98 }, { 22, 97, 63, 102, 101 }, { 23, 140, 105, 166, 159 }, { 36, 172, 127, 174, 148 }, { 17, 130, 106, 145, 125 }, { 28, 119, 100, 112, 127 }, { 43, 219, 122, 257, 192 }, });
        assertEquals(CtA, R);
        C.transposeMultiply(A, R);
        ...
        Matrix CtC = new TestImp(new double[][] { { 172, 60, 87, 162, 109, 100, 155 }, { 60, 74, 81, 84, 38, 94, 102 }, { 87, 81, 138, 124, 111, 89, 190 }, { 162, 84, 124, 181, 134, 125, 187 }, { 109, 38, 111, 134, 154, 50, 170 }, { 100, 94, 89, 125, 50, 143, 99 }, { 155, 102, 190, 187, 170, 99, 309 }, });
        assertEquals(CtC, R);
        C.transposeMultiply(C, R);
