...
import com.jstarcraft.ai.jsat.datatransform.featureselection.MutualInfoFS;
...
//        List<DataPoint> dps = new ArrayList<DataPoint>();
        ...
        CategoricalData[] catAtrs = new CategoricalData[] { new CategoricalData(3), new CategoricalData(3), new CategoricalData(2), // Info
