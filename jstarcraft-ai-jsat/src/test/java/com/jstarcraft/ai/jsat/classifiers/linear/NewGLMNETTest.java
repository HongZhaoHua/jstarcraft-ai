...
import com.jstarcraft.ai.jsat.classifiers.linear.NewGLMNET;
...
public class NewGLMNETTest {
    ...
    public void testWarmOther() {
        // Had difficulty making a problem hard enough to show improvment in warms tart
        // but also fast to run.
