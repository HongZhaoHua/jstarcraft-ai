...
public class SparseMatrixTest {
    ...
    public void testMutableAdd_double_Matrix() {
        ...
        int[] r = new int[] { 1, 2, 5, 3, 4, 6, 3, 4, 2, 6, 1, 3, 6, 3, 4, 5 };

        int[] c = new int[] { 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5, 5, 5, 6, 6, 6 };

        double[] v = new double[] { 1, 6, 4, 2, 1, -4, -7, 6, 7, 2, 8, 10, 3, 2, 8, 1 };
    ...
    public void testMutableAdd_double() {
        System.out.println("mutableAdd");
        DenseMatrix truth = new DenseMatrix(new double[][] { { 2, 2, 2, 2, 4, 2 }, { 5, 2, 2, 4, 2, 2 }, { 2, 2, 2, 2, 7, 3 }, { 2, 2, 5, 2, 2, 6 }, { 4, 2, 2, 2, 2, 2 }, { 2, 0, 2, 3, 2, 2 }, });
    ...
    public void testMultiply_3args_1() {
        ...
        Vec b = new DenseVector(new double[] { 5, 3, 3, 5, 4, 6 });

        Vec A2b = new DenseVector(new double[] { 42, 30, -30, 6, 12, 24 });
        Vec B2b = new DenseVector(new double[] { 16, 50, 52, 66, 20, -2 });
        Vec Ct2b = new DenseVector(new double[] { 6, 12, 20, 10, 10, 6, 8, 16 });
    ...
    public void testMultiply_Matrix_Matrix() {
        ...
        int[] rAB = new int[] { 1, 3, 4, 6, 5, 2, 3, 4, 5, 1, 3, 2, 3 };

        int[] cAB = new int[] { 1, 1, 1, 1, 2, 3, 4, 4, 4, 5, 5, 6, 6 };

        double[] vAB = new double[] { 8, 6, 3, 6, -2, 9, 4, 2, 1, 2, -35, 12, -7 };

        tmp = new SparseMatrix(6, 6);
        A.multiply(B, tmp);
        checkAgainstRCV(tmp, vAB, rAB, cAB);

        int[] rBA = new int[] { 2, 5, 2, 4, 6, 4, 6, 2, 3, 4, 5, 1, 3 };

        int[] cBA = new int[] { 1, 1, 2, 2, 2, 3, 4, 5, 5, 5, 5, 6, 6 };

        double[] vBA = new double[] { 3, 2, 2, 6, 1, -21, -6, 12, 3, 12, 8, 2, 5 };

        tmp = new SparseMatrix(6, 6);
        B.multiply(A, tmp);
        checkAgainstRCV(tmp, vBA, rBA, cBA);

        int[] rAC = new int[] { 3, 5, 1, 2, 2, 2, 3, 4, 1, 6, 1, 3 };

        int[] cAC = new int[] { 1, 2, 3, 3, 4, 5, 6, 6, 7, 7, 8, 8 };

        double[] vAC = new double[] { -7, 1, 1, 3, 3, 3, 2, 1, 4, 3, 1, -7 };

        tmp = new SparseMatrix(6, 8);
        A.multiply(C, tmp);
        checkAgainstRCV(tmp, vAC, rAC, cAC);

        int[] rCtB = new int[] { 6, 7, 2, 3, 4, 5, 2, 6, 1, 3, 8, 1, 3, 4, 5, 8 };

        int[] cCtB = new int[] { 1, 1, 2, 3, 3, 3, 4, 4, 5, 5, 5, 6, 6, 6, 6, 6 };

        double[] vCtB = new double[] { 3, 2, -2, 3, 3, 3, 1, 2, 5, 2, 7, 1, 4, 4, 4, 1 };
    ...
    public void testMutableMultiply_double() {
        ...
        int[] r = new int[] { 1, 3, 4, 3, 2, 1, 6, 5 };

        int[] c = new int[] { 1, 2, 2, 3, 4, 5, 5, 6 };

        double[] v = new double[] { 3, 6, 3, -21, 9, 12, 9, 3 };
    ...
    public void testMutableTranspose() {
        ...
        int[] r = new int[] { 1, 5, 4, 2, 3, 2, 6, 5 };

        int[] c = new int[] { 1, 1, 2, 3, 3, 4, 5, 6 };

        double[] v = new double[] { 1, 4, 3, 2, -7, 1, 1, 3 };
    ...
    public void testTranspose() {
        ...
        int[] rAt = new int[] { 1, 5, 4, 2, 3, 2, 6, 5 };

        int[] cAt = new int[] { 1, 1, 2, 3, 3, 4, 5, 6 };

        double[] vAt = new double[] { 1, 4, 3, 2, -7, 1, 1, 3 };
    ...
    public void testTransposeMultiply_Matrix_Matrix() {
        ...
        int[] rAtB = new int[] { 4, 6, 5, 2, 4, 5, 1, 2, 3, 5, 2, 3 };

        int[] cAtB = new int[] { 1, 1, 2, 3, 4, 4, 5, 5, 5, 5, 6, 6 };

        double[] vAtB = new double[] { 9, 2, -6, 3, 6, 3, 2, 10, -35, 8, 6, -7 };

        tmp = new SparseMatrix(6, 6);
        A.transposeMultiply(B, tmp);
        checkAgainstRCV(tmp, vAtB, rAtB, cAtB);

        int[] rBtA = new int[] { 5, 3, 5, 6, 5, 6, 1, 4, 2, 4, 5, 1 };

        int[] cBtA = new int[] { 1, 2, 2, 2, 3, 3, 4, 4, 5, 5, 5, 6 };

        double[] vBtA = new double[] { 2, 3, 10, 6, -35, -7, 9, 6, -6, 3, 8, 2 };

        tmp = new SparseMatrix(6, 6);
        B.transposeMultiply(A, tmp);
        checkAgainstRCV(tmp, vBtA, rBtA, cBtA);

        int[] rAtC = new int[] { 2, 3, 5, 1, 2, 5, 2, 2, 4, 6, 1, 2, 3, 5 };

        int[] cAtC = new int[] { 1, 1, 2, 3, 3, 3, 4, 5, 6, 7, 8, 8, 8, 8 };

        double[] vAtC = new double[] { 2, -7, 3, 1, 1, 4, 1, 1, 3, 1, 1, 2, -7, 4 };
    ...
    public void testTransposeMultiply_3args_2() {
        ...
        Vec A2b = new DenseVector(new double[] { 10, 22, -42, 18, 76, 8 });
        Vec B2b = new DenseVector(new double[] { 34, -24, 30, 24, 50, 46 });
        Vec Ct2b = new DenseVector(new double[] { 6, 12, 20, 10, 10, 6, 8, 16 });
    ...
    public void testSwapRows() {
        ...
        int[] r = new int[] { 6, 3, 4, 3, 2, 1, 6, 5 };

        int[] c = new int[] { 1, 2, 2, 3, 4, 5, 5, 6 };

        double[] v = new double[] { 1, 2, 1, -7, 3, 3, 4, 1 };
