...
import com.jstarcraft.ai.jsat.clustering.evaluation.NormalizedMutualInformation;
...
public class NormalizedMutualInformationTest {
    ...
    public void testEvaluate_intArr_DataSet() {
        ...
        ClassificationDataSet cds = new ClassificationDataSet(0, new CategoricalData[] {}, new CategoricalData(3));
