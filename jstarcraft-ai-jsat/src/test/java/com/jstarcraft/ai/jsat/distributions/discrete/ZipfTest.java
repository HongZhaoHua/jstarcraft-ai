...
import com.jstarcraft.ai.jsat.distributions.discrete.Zipf;
...
public class ZipfTest {
    ...
    public static void setUpClass() {
        ...
        Zs = new Zipf[] { Zipf_20k_half, Zipf_20k_2, Zipf_inf_half, Zipf_inf_2, };
    }
    ...
    public void testCdf() {
        ...
        double[][] expected = new double[][] { { 0, 0.38487689516722987426, 0.52095142641461597679, 0.59502101942450515792, 0.64313063132040889220, 0.67755506734292834373, 0.76795891437272322068, 0.92865949153851453895, 0.98110724498011254401, 0.99774556774377231118, 1.0000000000000000000, 1.0000000000000000000 }, { 0, 0.83190737344575156199, 0.93589579512647050724, 0.96670717932816500953, 0.97970573203825487769, 0.98636099102582089019, 0.99623568881949349504, 0.99995881954514754426, 0.99999958550189121097, 0.99999999688071128956, 1.0000000000000000000, 1.0000000000000000000 }, { 0, 0.38279338399942656225, 0.51813128280909685246, 0.59179990390778908901, 0.63964907690771740929, 0.67388715802611333375, 0.76380160850531216055, 0.92363224140736199479, 0.97579607164807706923, 0.99234432371191855118, 0.99458655171571673136, 0.99458668704346583298 },
...
//                System.out.println(xs[i] + ", " + zipf.invCdf(ex) + ", " + zipf.invCdf(acc));
    ...
    public void testMean() {
        ...
        double[] expected = new double[] { 108.29892902835748493, 1.3683911847143409720, Double.POSITIVE_INFINITY, 1.3684327776202058757 };
    ...
    public void testVariance() {
        ...
        double[] expected = new double[] { 714029.31029974343795, 6.8465006485901065799, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY };
    ...
    public void testSkewness() {
        ...
        double[] expected = new double[] { 14.048173897535615783, 927.04482492331320690, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY };
    ...
    public void testMax() {
        ...
        double[] expected = new double[] { 20000, 20000, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY };
