...
import com.jstarcraft.ai.jsat.regression.evaluation.CoefficientOfDetermination;
...
public class CoefficientOfDeterminationTest {
    ...
    public void testGetScore() {
        ...
        double[] pred = new double[] { 0, 2, 4, 6, 8, 9 };

        double[] truth = new double[] { 0.5, 2, 3, 1, 8.5, 10 };
