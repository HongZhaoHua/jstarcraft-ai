...
import com.jstarcraft.ai.jsat.linear.distancemetrics.PearsonDistance;
...
public class PearsonDistanceTest {
    ...
    public void testCorrelation() {
        ...
        Vec[][] pairs = new Vec[][] { { x1, x2 }, { x2, x1 }, { x2, x2 }, { x3, x4 }, { x4, x3 }, { x1, x5 }, { x3, x5 }, { x4, x5 }, };

        double[] expectedVals = new double[] { 0.5298089018901744, 0.5298089018901744, 1.0, -0.16532953228838151, -0.16532953228838151, -0.2587220950032312, 0.5995147431422027, -0.2625496015918526, };
    ...
    public void testCorrelationBNZ() {
        ...
        double[] expectedVals = new double[] { 0.5298089018901744, 0.5298089018901744, 1.0, -0.7254024447917231, -0.7254024447917231, 0.7425697235686509, 1.0, 1.0, };
