...
public class MatrixTest {
    ...
    public void testOuterProductUpdate_4args() {
        ...
        double[][] expected = new double[][] { { 11, 12, 14, 16 }, { 20, 25, 28, 32 }, { 30, 36, 43, 48 }, { 40, 48, 56, 65 }, };
    ...
    public void testDiagMult_Matrix_Vec() {
        ...
        Matrix A = new DenseMatrix(new double[][] { { 0, 8, 7, 5, 5 }, { 6, 10, 4, 8, 4 }, { 10, 7, 5, 8, 6 }, { 5, 2, 2, 5, 5 }, { 6, 7, 10, 5, 8 }, });

        Vec b = new DenseVector(new double[] { 4, -3, 3, -4, 2 });

        double[][] expected = new double[][] { { 0, -24, 21, -20, 10 }, { 24, -30, 12, -32, 8 }, { 40, -21, 15, -32, 12 }, { 20, -6, 6, -20, 10 }, { 24, -21, 30, -20, 16 }, };
        Matrix.diagMult(A, b);
    ...
    public void testDiagMult_Vec_Matrix() {
        ...
        double[][] expected = new double[][] { { 0, 32, 28, 20, 20 }, { -18, -30, -12, -24, -12 }, { 30, 21, 15, 24, 18 }, { -20, -8, -8, -20, -20 }, { 12, 14, 20, 10, 16 }, };
