...
public class CSVTest {
    ...
    public void testReadNumericCatFeats() throws Exception {
        ...
        CategoricalData[] cats = new CategoricalData[] { new CategoricalData(2), new CategoricalData(4), };
        ...
        // when read back in, cat features are at the end b/c we always write out cats
        // at the end
    ...
    public void testWriteRead() {
        CategoricalData[] cats = new CategoricalData[] { new CategoricalData(2), new CategoricalData(4), new CategoricalData(3), };
        cats[0].setOptionName("A", 0);
        cats[0].setOptionName("B", 1);
