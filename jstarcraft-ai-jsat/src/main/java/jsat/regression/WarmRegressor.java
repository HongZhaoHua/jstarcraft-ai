...
public interface WarmRegressor extends Regressor {
     ...
     * {@code true} will be returned. The behavior for training on a different data
     * set when this is defined is undefined. It may cause an error, or it may cause
     * the algorithm to take longer or reach a worse solution. <br>
     ...
     * the data set.
     * 
     * @return {@code true} if the algorithm can only be warm started from the model
     *         trained on the exact same data set.
     */
