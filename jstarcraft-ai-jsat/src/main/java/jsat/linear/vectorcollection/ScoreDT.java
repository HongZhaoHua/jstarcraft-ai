...
public interface ScoreDT {
     ...
     * simply returns the original score that was given and does no computation. If
     * the given original score does not look valid (is less than zero), the score
     * will be re-computed. Some algorithms may choose to implement this method when
     * pruning is best done after initial depth-first traversals have already been
     * completed of other branches.
     *
     * @param ref
     * @param query
     * @param origScore
