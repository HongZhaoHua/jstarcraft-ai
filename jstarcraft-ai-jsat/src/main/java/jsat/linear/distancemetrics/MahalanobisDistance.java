...
public class MahalanobisDistance extends TrainableDistanceMetric {
     ...
     * once it has been trained once. This will mean {@link #needsTraining() } will
     * always return true. <tt>false</tt> means the metric will not indicate a need
     * to be retrained once it has been trained once.
     * 
     * @return <tt>true</tt> if the data should always be retrained, <tt>false</tt>
     *         if it should not.
     */
     ...
     * <tt>true</tt> if this metric will indicate a need to be retrained once it has
     * been trained once. This will mean {@link #needsTraining() } will always
     * return true. <tt>false</tt> means the metric will not indicate a need to be
     * retrained once it has been trained once.
     * 
     * @param reTrain <tt>true</tt> to make the metric always request retraining,
