...
public class RowColumnOps {
    /**
     * Updates the values along the main diagonal of the matrix by adding a constant
     * to them
     * 
    ...
    /**
     * Updates the values of row <tt>i</tt> in the given matrix to be A[i,:] =
     * A[i,:] .* c[i] The Matrix <tt>A</tt> and array <tt>c</tt> do not need to have
     * the same dimensions, so long as they both have indices in the given range.
     * 
     * @param A     the matrix to perform he update on
     * @param i     the row to update
     * @param start the first index of the row to update from (inclusive)
     ...
     * @param c     the array of values to pairwise multiply by <tt>t</tt> before
     ...
     * @param to    the last index of the row to update (exclusive)
     * @param t     the constant to multiply all elements of <tt>c</tt> by
     * @param c     the vector of values to pairwise multiply by <tt>t</tt> before
     *              adding to the elements of A
     */
