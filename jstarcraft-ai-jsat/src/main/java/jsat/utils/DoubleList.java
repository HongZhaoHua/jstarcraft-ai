...
public class DoubleList extends AbstractList<Double> implements Serializable, RandomAccess {
    ...
    /**
     * This method treats the underlying list as a stack. Pushes an item onto the
     * top of this "stack".
     * 
    ...
    /**
     * This method treats the underlying list as a stack. Removes the item at the
     * top of this "stack" and returns that item as the value.
     *
    ...
    /**
     * This method treats the underlying list as a stack. Gets the item at the top
     * of this "stack" and returns that item as the value, but leaves it on the
     * stack.
     *
     * @return the item at the top of this stack (the last item pushed onto it)
     */
    ...
    /**
     * Obtains a view of this double list as a dense vector with equal length. This
     * is a soft reference, and altering the values in the matrix with alter the
     * double list, and vise versa. <br>
     * <br>
     * While no error will be thrown if the size of the underlying list changes,
     * this view should be discarded if the size of the list changes. Once the list
     * has changed sizes, there is no guarantee on the behavior that will occur if
     * the vector is used.
     * 
     ...
     * the array, a new array will be allocated - at which point operations will no
     * longer be reflected in the original array.
     * 
     * @param array  the array to wrap by a DoubleList object
     * @param length the initial length of the list
     * @return a DoubleList backed by the given array, unless modified to the point
