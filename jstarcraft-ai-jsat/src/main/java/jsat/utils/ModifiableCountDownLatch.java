...
public class ModifiableCountDownLatch {
    ...
    /**
     * Waits until the count gets reduced to zero, and then all threads waiting will
     * get to run.
     * 
    ...
    /**
     * Increments the count. Once the count has reached zero once, incrementing the
     * count back above zero will have no affect.
     */
    public void countUp() {
        count.addAndGet(1);
    }
