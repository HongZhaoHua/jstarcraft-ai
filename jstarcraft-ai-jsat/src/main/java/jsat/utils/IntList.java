...
public class IntList extends AbstractList<Integer> implements Serializable, RandomAccess {
    ...
    /**
     * Creates and returns an unmodifiable view of the given int array that requires
    ...
    /**
     * Creates and returns a view of the given int array that requires only a small
     * object allocation. Changes to the list will be reflected in the array up to a
     * point. If the modification would require increasing the capacity of the
     * array, a new array will be allocated - at which point operations will no
     ...
     * @return an IntList backed by the given array, unless modified to the point of
     *         requiring the allocation of a new array
     */
     ...
     * @return a new IntList populated by integer values as if having run through a
     *         for loop
     */
