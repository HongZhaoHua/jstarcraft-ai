...
public class SimpleDataSet extends DataSet<SimpleDataSet> {
    ...
    /**
     * Converts this dataset into one meant for classification problems. The given
     * categorical feature index is removed from the data and made the target
     * variable for the classification problem.
     *
     * @param index the classification variable index, should be in the range [0,
     *              {@link #getNumCategoricalVars() })
     * @return a new dataset where one categorical variable is removed and made the
     *         target of a classification dataset
     */
    ...
    /**
     * Converts this dataset into one meant for regression problems. The given
     * numeric feature index is removed from the data and made the target variable
     * for the regression problem.
     *
     * @param index the regression variable index, should be in the range [0,
     *              {@link #getNumNumericalVars() })
     * @return a new dataset where one numeric variable is removed and made the
     *         target of a regression dataset
     */
    ...
    /**
     *
     * @return access to a list of the list that backs this data set. May or may not
     *         be backed by the original data.
     */
