...
public interface BinaryScoreClassifier extends Classifier {
    /**
     * Returns the numeric score for predicting a class of a given data point, where
     * the sign of the value indicates which class the data point is predicted to
     * belong to.
     * 
