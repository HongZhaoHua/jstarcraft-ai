...
public class PegasosK extends SupportVectorLearner implements BinaryScoreClassifier, Parameterized {
     ...
     * 
     * @param regularization the amount of regularization to apply, normally a very
    ...
    /**
     * Sets the number of iterations of the algorithm to perform. Each iteration may
     * or may not update a single coefficient for a specific data point.
     * 
