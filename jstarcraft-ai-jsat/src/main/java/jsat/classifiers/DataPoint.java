...
public class DataPoint implements Cloneable, Serializable {
     ...
     * 
     * @param numericalValues   a vector containing the numerical values for this
     *                          data point
     * @param categoricalValues an array of the category values for this data point
     * @param categoricalData   an array of the category information of this data
     *                          point
     */
     ...
     * 
     * @param numericalValues a vector containing the numerical values for this data
     *                        point
     */
    ...
    /**
     * Returns the vector containing the numerical values. Altering this vector will
     * effect this data point. If changes are going to be made, a clone of the
     * vector should be made by the caller.
     * 
     ...
     * effect this data point. If changes are going to be made, a clone of the array
    ...
    /**
     * Creates a deep clone of this data point, such that altering either data point
     * does not effect the other one.
     * 
     * @return a deep clone of this data point.
     */
    public DataPoint clone() {
        return new DataPoint(numericalValues.clone(), Arrays.copyOf(categoricalValues, categoricalValues.length), CategoricalData.copyOf(categoricalData));
    }
}
