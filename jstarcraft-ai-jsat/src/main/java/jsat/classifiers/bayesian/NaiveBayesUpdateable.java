...
public class NaiveBayesUpdateable extends BaseUpdateableClassifier {
    ...
    /**
     * Sets whether or not that classifier should behave as if the input vectors are
     * sparse. This means zero values in the input will be ignored when performing
     * classification.
     * 
