...
public class ConditionalProbabilityTable implements Classifier {
     ...
     * @param targetClass the index in the original data set of the category that we
     *                    would like to predict
     * @param cord        the array to store the coordinate in.
     * @return the value of the target class for the given data point
     * @throws ArithmeticException if the <tt>cord</tt> array does not match the
     ...
     * @param categoriesToUse the attributes to use in training. Each value
     *                        corresponds to the categorical index in
     *                        <tt>dataSet</tt>, and adding the value
     *                        {@link DataSet#getNumCategoricalVars() }, which is not
     *                        a valid index, indicates to used the
     *                        {@link ClassificationDataSet#getPredicting()
     *                        predicting class} of the data set in the CPT.
     */
     ...
     * 
     * @param targetClass the index in the original data set of the class that we
     *                    want the probability of
     * @param dataPoint   the data point of values paired with the value of the
     *                    predicting attribute in the original training set
     * @return the probability in [0,1] of the target class value occurring with the
     *         given DataPointPair
     */
     ...
     * 
     * @param targetClass the index in the original data set of the class that we
     *                    want to probability of
     * @param targetValue the value of the <tt>targetClass</tt> that we want to
     *                    probability of occurring
     * @param cord        the coordinate array that corresponds the the class values
     *                    for the CPT, where the coordinate of the
