...
public class Bagging implements Classifier, Regressor, Parameterized {
     ...
     * 
     * @param baseClassifier       the base learner to use.
     * @param extraSamples         how many extra samples past the training size to
     *                             take
     * @param simultaniousTraining controls whether base learners are trained
    ...
    /**
     * Bagging produces multiple base learners. These can all be trained at the same
     * time, using more memory, or sequentially using the base learner's parallel
     * training method. If set to true, the base learners will be trained
     * simultaneously.
     * 
     * @param simultaniousTraining true to train all learners at the same time,
     *                             false to train them sequentially
     */
    ...
    public void train(final ClassificationDataSet dataSet, final boolean parallel) {
        ...
        // Used to make the main thread wait for the working threads to finish before
        // submiting a new job so we dont waist too much memory then we can use at once
    ...
    /**
     * Creates a new data set from the given sample counts. Points sampled multiple
     * times will have multiple entries in the data set.
     * 
    ...
    /**
     * Creates a new data set from the given sample counts. Points sampled multiple
     * times will be added once to the data set with their weight multiplied by the
    ...
    /**
     * Performs the sampling based on the number of data points, storing the counts
     * in an array to be constructed from XXXX
     * 
     * @param sampleCounts an array to keep count of how many times each data point
     *                     was sampled. The array will be filled with zeros before
     *                     sampling starts
