...
public class Imputer implements InPlaceTransform {
    ...
    public void fit(DataSet d) {
        ...
        if (mode == NumericImputionMode.MEDIAN) {
            ...
            for (int col = 0; col < d.getNumNumericalVars(); col++) {
                ...
                // we are going to loop through until we reach past the half weight mark,
                // getting us the weighted median
    ...
    public DataPoint transform(DataPoint dp) {
        ...
        // TODO, sparse vec case can be handled better by making a and setting it
        // seperatly
