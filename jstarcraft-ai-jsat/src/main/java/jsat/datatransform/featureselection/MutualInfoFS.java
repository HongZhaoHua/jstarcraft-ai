...
public class MutualInfoFS extends RemoveAttributeTransform {
    ...
    public enum NumericalHandeling {
        ...
        NONE,
        /**
         * Numeric attributes are treated as nominal features with binary values. The
         * false value is if the value is zero, and the true value is any non zero
         * value.
         */
        BINARY,
    }
    ...
    /**
     * Creates a new Mutual Information feature selection object that attempts to
     * select up to 100 features. Numeric attributes are handled by
    ...
    /**
     * Creates a new Mutual Information feature selection object. Numeric attributes
     * are handled by {@link NumericalHandeling#BINARY}
     * 
     ...
     * Creates a new Mutual Information feature selection object.
     *
     * @param dataSet         the classification data set to perform feature
     *                        selection from
     * @param featureCount    the number of features to select
     * @param numericHandling the way to handle the computation of mutual
     *                        information for numeric attributes
