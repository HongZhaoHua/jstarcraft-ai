...
public class LinearTransform implements InPlaceInvertibleTransform {
    ...
    /**
     * Creates a new Linear Transformation that will scale values to the [0, 1]
     * range.
     * 
     */
    ...
    /**
     * Creates a new Linear Transformation for the input data set so that all values
    ...
    /**
     * Sets the min and max value to scale the data to. If given in the wrong order,
     * this method will swap them
     * 
     * @param A the maximum value for the transformed data set
     * @param B the minimum value for the transformed data set
     */
