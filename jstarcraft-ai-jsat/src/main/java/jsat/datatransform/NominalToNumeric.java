...
public class NominalToNumeric implements DataTransform {
    ...
    /**
     * Creates a new transform to convert categorical to numeric features for the
     * given dataset
     * 
    ...
    public DataPoint transform(DataPoint dp) {
        ...
        // TODO we should detect if there are going to be so many sparce spaces added by
        // the categorical data that we should just choose a sparce vector anyway
