...
public class NumericalToHistogram implements DataTransform {
    ...
    /**
     * Creates a new transform which will use the specified number of bins for each
     * numeric feature.
     * 
     * @param dataSet the data set to create the transform from
     * @param n       the number of bins to create
    ...
    /**
     * Sets the maximum number of histogram bins to use when creating the
     * categorical version of numeric features.
     * 
     * @param n the number of bins to create
     */
