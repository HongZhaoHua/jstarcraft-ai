...
public class NaiveTokenizer implements Tokenizer {
    ...
    /**
     * Sets whether or not all non letter and digit characters are treated as white
     * space, or ignored completely. If ignored, the tokenizer parses the string as
     * if all non letter, digit, and whitespace characters did not exist in the
     * original string.<br>
     * <br>
     * Setting this to {@code false} can result in a lower feature count, especially
     * for noisy documents.
     * 
    ...
    /**
     * Sets the maximum allowed length for any token. Any token discovered exceeding
     * the length will not be accepted and skipped over. The default is unbounded.
     * 
    ...
    /**
     * Sets the minimum allowed token length. Any token discovered shorter than the
     * minimum length will not be accepted and skipped over. The default is 0.
     * 
