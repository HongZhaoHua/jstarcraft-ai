...
public interface WordWeighting extends IndexFunction {
     ...
     * called once before being applied to any vectors. Different WordWeightings may
     * require different amounts of computation to set up.
     * 
     * @param allDocuments the list of all vectors that make up the set of
     *                     documents. The word vectors should be unmodified,
     *                     containing the value of how many times a word appeared in
     *                     the document for each index.
     * @param df           a list mapping each integer index of a word to how many
     *                     times that word occurred in total
     */
     ...
     * {@link Vec#applyIndexFunction(jsat.math.IndexFunction) } . The vector should
