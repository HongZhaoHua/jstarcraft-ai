 ...
 * <br>
 * The {@link #pdf(double) }, {@link #cdf(double) }, and the
 * {@link #invCdf(double) } methods are implemented efficiently, with little
 * overhead per call. All other methods are approximated numerically, and incur
 * more overhead.
 *
...
public class TruncatedDistribution extends ContinuousDistribution {
    ...
    public double invCdf(double p) {
        ...
        // rescale p to the range of p values that are acceptable to the base
        // distribution now
