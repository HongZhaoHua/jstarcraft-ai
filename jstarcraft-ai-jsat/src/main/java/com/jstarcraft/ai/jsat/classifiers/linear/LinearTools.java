...
public class LinearTools {
     ...
     * <br>
     * Note, that the value returned depends on the data set size. If being used to
     * initialize the value of &lambda; for cross validation with k-folds, the value
     * (k-1)/k * &lambda; will be closer to the correct value of &lambda; for each
     * CV set.
     *
    ...
    /**
     * Many linear classifiers can be phrased in two equivalent forms, that only
     * change the notation for the regularized. These forms are:<br>
     * C <big>&sum;</big><sub>i</sub> &#x2113;(w,x<sub>i</sub>) + &Omega;(w) <br>
     * and<br>
     * 1/N <big>&sum;</big><sub>i</sub> &#x2113;(w,x<sub>i</sub>) + &lambda;
     * &Omega;(w) <br>
     * 
     * This method converts the regularization parameter &lambda; to the form used
     * as C
     * 
     ...
     * &Omega;(w) <br>
     * 
     * This method converts the regularization parameter C to the form used as
     * &lambda;
     * 
