...
import com.jstarcraft.ai.jsat.math.optimization.LBFGS;
import com.jstarcraft.ai.jsat.math.optimization.Optimizer;
...
public class LinearBatch implements Classifier, Regressor, Parameterized, SimpleWeightVectorModel, WarmClassifier, WarmRegressor {
     ...
     * valid for this value, in which case the implementation will attempt to select
     * a reasonable optimizer automatically. <br>
     * <br>
     ...
     * While zero is a valid tolerance value, it is not usually useful in practice.
     * Values in [10<sup>-4</sup>, 10<sup>-2</sup>] are usually more practical.
     * 
    ...
    private class VecWithBias extends Vec {
        ...
        // 2 hacks below to make the original code work with bias terms "transparently"
        // This means we need to know which functions will be called with a miss-matched
        // size
