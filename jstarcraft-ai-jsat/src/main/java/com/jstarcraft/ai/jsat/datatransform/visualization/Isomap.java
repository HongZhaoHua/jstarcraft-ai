 ...
 * implementation also includes the extension {@link #setCIsomap(boolean)
 * C-Isomap}, which further weights distances by density.<br>
 * <br>
 ...
 * Processing Systems 15 (pp. 705–712). MIT Press. Retrieved from <a href=
 * "http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.9.3407&amp;rep=rep1&amp;type=pdf">here</a></li>
 * </ul>
 *
...
public class Isomap implements VisualizationTransform {
     ...
     * 
     * @param searchNeighbors the number of nearest neighbors to consider
     * @param c_isomap        {@code true} to use the C-Isomap extension,
     *                        {@code false} for normal Isomap.
     */
     ...
     * distances will also be scaled based on the density of the region between the
     * points. If false, normal Isomap will be used.
     *
     * @param c_isomap {@code true} to use the C-Isomap extension, {@code false} for
     *                 normal Isomap.
     */
    ...
    /**
     *
     * @return {@code true} if the C-Isomap extension is in use, {@code false} for
     *         normal Isomap.
     */
    ...
    public <Type extends DataSet> Type transform(DataSet<Type> d, boolean parallel) {
        ...
        // we will use the largest obtainable distance to be an offset for our infinity
        // distances
