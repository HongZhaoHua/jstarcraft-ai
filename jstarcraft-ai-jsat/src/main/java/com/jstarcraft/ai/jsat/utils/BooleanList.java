...
/**
 * Provides a modifiable implementation of a List using a boolean array. This
 * provides considerable memory efficency improvements over using an
 * {@link ArrayList} to store booleans. <br>
...
public class BooleanList extends AbstractList<Boolean> implements Serializable, RandomAccess {
    ...
    /**
     * Creates an returns an unmodifiable view of the given boolean array that
    ...
    /**
     * Creates and returns a view of the given boolean array that requires only a
     ...
     * @return a BoolaenList backed by the given array, unless modified to the point
