 ...
 * and educational reasons. For efficient exact k-Means, use
 * {@link ElkanKMeans}<br>
 * <br>
...
public class NaiveKMeans extends KMeans {
    ...
    /**
     * Creates a new naive k-Means cluster using {@link SeedSelection#KPP k-means++}
     * for the seed selection and the {@link EuclideanDistance}
     */
    public NaiveKMeans() {
