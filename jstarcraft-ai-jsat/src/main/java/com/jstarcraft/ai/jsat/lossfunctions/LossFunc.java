package com.jstarcraft.ai.jsat.lossfunctions;
...
public interface LossFunc extends Serializable {
    ...
    /**
     * Computes the result of the conjugate function of this loss. This function is
     * generally optional, and should return {@link Double#NaN} if not properly
     * implemented. Many optimization algorithms do require a working implementation
     * though.
     * 
    ...
    /**
     * Returns an upper bound on the maximum value of the second derivative. If the
     * second derivative does not exist, {@link Double#NaN} is a valid result. It is
     * also possible for {@code 0} and {@link Double#POSITIVE_INFINITY} to be valid
     * results, and must be checked for.
     *
    ...
    /**
     * If this loss is L-Lipschitz (1/L Lipschitz smooth), this method will return
     * the value of L. If it is not L-Lipschitz, a value of 0 will be returned.
     * 
