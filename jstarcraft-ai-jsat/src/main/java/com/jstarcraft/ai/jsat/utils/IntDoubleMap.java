...
public final class IntDoubleMap extends AbstractMap<Integer, Double> {
     ...
     *              non-present keys behave as having an implicit value of zero, in
     *              which case the delta value is directly inserted into the map.
    ...
    /**
     * Returns the value to which the specified key is mapped, or {@link Double#NaN}
     * if this map contains no mapping for the key.
     *
     * @param key the key whose associated value is to be returned
     * @return the value to which the specified key is mapped, or {@link Double#NaN}
     *         if this map contains no mapping for the key
     */
    ...
    private void enlargeIfNeeded() {
        ...
        int newSize = getNextPow2TwinPrime(status.length * 3 / 2);// it will actually end up doubling in size since we have twin primes spaced
                                                                  // that was
