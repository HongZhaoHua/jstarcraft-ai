...
import com.jstarcraft.ai.jsat.distributions.multivariate.NormalMR;
...
public class DensityOutlier implements Outlier {
    ...
    /**
     * Threshold for what counts as an outlier. Any value less than or equal to this
     * threshold will be considered an outlier.
     */
