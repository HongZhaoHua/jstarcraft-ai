...
public class Forgetron extends BaseUpdateableClassifier implements BinaryScoreClassifier, Parameterized {
    ...
    private int size;
    /**
     * Will always point to current insert position. Either empty, or the last value
     * ever inserted
     */
    private int curPos;
    private int budget;
     ...
     *
     * @param selfTurned {@code true} to use the self-tuned variance, {@code false}
     *                   otherwise.
     */
    ...
    /**
     * Sets the new budget, which is the maximum number of data points the Forgetron
     * can use to form its decision boundary.
     * 
     * @param budget the maximum number of data points to use
     */
