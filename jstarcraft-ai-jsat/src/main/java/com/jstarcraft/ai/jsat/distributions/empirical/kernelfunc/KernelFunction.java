...
public interface KernelFunction extends Serializable {
    ...
    /**
     * As the value of |u| for the kernel function approaches infinity, the value of
     * k(u) approaches zero. This function returns the minimal absolute value of u
     * for which k(u) returns 0
     * 
