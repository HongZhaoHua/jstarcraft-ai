...
public class HingeLoss implements LossMC {
    ...
    public double lipschitz() {
        ...
        // Shalev-Shwartz, S., & Zhang, T. (2012). Stochastic Dual Coordinate Ascent
        // Methods for Regularized Loss Minimization. Journal ofMachine Learning
        // Research, 14, 567–599. Machine Learning; Learning; Optimization and Control.
        // Retrieved from http://arxiv.org/abs/1209.1873
        return 1;
    }
}
