...
public interface DataStore {
     ...
     * expected number of numeric and categorical features to be added to this data
     * store.
     *
     * @param dp the data point to add
     */
    ...
    /**
     * This is called to indicate to the data store that we are done adding values.
     * This does not mean that values can not be added in the future, but this
     * allows the implementation to perform cleanup.
     */
    ...
    /**
     * Sets the number of numerical features that will be stored in this datastore
     * object
     * 
     * @param d the number of numerical features (i.e., dimensions) that should be
     *          stored.
     */
    ...
    /**
     *
     * @return the number of categorical features that are contained by data in this
     *         store.
     */
    ...
    /**
     * This method grabs all the categorical values for a 'column' and returns it as
     * an array. <br>
     * This array can be altered and will not effect any of the values in the data
     * set
     *
    ...
    /**
     * Returns statistics on the sparsity of the vectors in this data store. Vectors
    ...
    /**
     * Creates a new data store that is the same type as this one, but contains no
     * data points.
     *
     * @return a new data store that is the same type as this one, but contains no
     *         data points.
     */
