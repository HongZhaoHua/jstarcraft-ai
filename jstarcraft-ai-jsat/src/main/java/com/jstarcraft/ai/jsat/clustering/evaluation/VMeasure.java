...
public class VMeasure implements ClusterEvaluation {
     ...
     * completeness is weighted more strongly in the calculation, if β is less than
     * 1, homogeneity is weighted more strongly
     *
     * @param beta the weight preference to apply to completeness (greater than one)
     *             or homogeneity ( less than 1 but &gt; 0).
     */
