...
public interface KernelTrick extends Parameterized, Cloneable, Serializable {
     ...
     * information generated by {@link #getQueryInfo(com.jstarcraft.ai.jsat.linear.Vec) }. <br>
     * If the cache input is {@code null}, then
     * {@link #eval(com.jstarcraft.ai.jsat.linear.Vec, com.jstarcraft.ai.jsat.linear.Vec) } will be called directly.
     * 
