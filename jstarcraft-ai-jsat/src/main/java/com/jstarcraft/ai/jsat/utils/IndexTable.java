...
public class IndexTable implements Serializable {
     ...
     * meaning the original input would be returned in its original order instead of
     * sorted order.
     */
    public void reset() {
    ...
    /**
     * Given the index <tt>i</tt> into what would be the sorted array, the index in
     * the unsorted original array is returned. <br>
    ...
    /**
     * Applies this index table to the specified target, putting {@code target} into
     * the same ordering as this IndexTable.
     * 
     * @param target the array to re-order into the sorted order defined by this
     *               index table
     * @throws RuntimeException if the length of the target array is not the same as
     *                          the index table
     */
     ...
     * the same ordering as this IndexTable.
     * 
     * @param target the list to re-order into the sorted order defined by this
     *               index table
     * @throws RuntimeException if the length of the target List is not the same as
     *                          the index table
     */
    ...
    /**
     * Applies this index table to the specified target, putting {@code target} into
     * the same ordering as this IndexTable. It will use the provided {@code tmp}
     * space to store the original values in target in the same ordering. It will be
     * modified, and may be expanded using the {@link List#add(java.lang.Object)
     * add} method if it does not contain sufficient space. Extra size in the tmp
     * list will be ignored. After this method is called, {@code tmp} will contain
     * the same ordering that was in {@code target} <br>
     * <br>
     * This method is provided as a means to reducing memory use when multiple lists
     * need to be sorted.
     * 
