...
public interface IndexNode<N extends IndexNode> {
    ...
    /**
     * 
     * @return returns the parent node to this one, or {@code null} if this node is
     *         the root.
     */
    public N getParrent();

    /**
     * This method returns a lower bound on the minimum distance from a point in or
     * owned by this node to any point in or owner by the {@code other} node.
     * Because the value return is a lower bound, 0 would always be a valid return
     * value.
     *
     ...
     * 
     * @param other
     * @return an array where the first value is the minimum distance between nodes,
     *         and second value is the maximum
     */
    ...
    /**
     * This method returns a lower bound on the minimum distance from a point in or
     * owned by this node to the {@code other} point. Because the value return is a
     * lower bound, 0 would always be a valid return value.
     * 
     * @param other
     * @return
     */
    ...
    /**
     * Gets the distance from this node (or its centroid) to it's parent node (or
     * centroid).
     * 
     * @return
     */
    ...
    /**
     * Returns an upper bound on the farthest distance from this node to any of the
     * points it owns. <br>
     * <br>
    ...
    /**
     * Returns an upper bound on the farthest distance from this node to any of the
     * points it owns or its children own. <br>
     * <br>
     * In the Dual Tree papers, this is often given as λ(Ni)
     * 
     * @return an upper bound on the distance
     */
