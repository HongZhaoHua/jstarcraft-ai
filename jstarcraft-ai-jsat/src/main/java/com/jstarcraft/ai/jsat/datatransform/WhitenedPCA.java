...
import static com.jstarcraft.ai.jsat.linear.MatrixStatistics.covarianceMatrix;
import static com.jstarcraft.ai.jsat.linear.MatrixStatistics.meanVector;
...
public class WhitenedPCA extends DataTransformBase {
     ...
     * Creates a new WhitenedPCA transform
     *
     * @param regularization the amount of regularization to add, avoids numerical
     *                       instability
     * @param dims           the number of dimensions to project down to
     */
    ...
    /**
     * Creates a new WhitenedPCA. The dimensions will be chosen so that the subset
     * of dimensions is of full rank. The regularization parameter will be chosen as
    ...
    /**
     * Creates a new WhitenedPCA. The regularization parameter will be chosen as the
     * log of the condition of the covariance.
     * 
     * @param dataSet the data set to whiten
     * @param dims    the number of dimensions to project down to
     */
     ...
     *                       decomposition. This can improve numeric stability and
     *                       reduces noise.
     */
