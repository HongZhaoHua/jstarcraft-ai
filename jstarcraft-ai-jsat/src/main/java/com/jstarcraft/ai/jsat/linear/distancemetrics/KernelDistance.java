...
import com.jstarcraft.ai.jsat.distributions.kernels.PolynomialKernel;
...
public class KernelDistance implements DistanceMetric {
     ...
     * <br>
     * &forall; c<sub>i</sub> &isin; &real; , x<sub>i</sub> &isin;
     * &real;<sup>d</sup> <br>
     * &sum;<sub>i, j = 1</sub><sup>m</sup> c<sub>i</sub> c<sub>j</sub>
     * K(x<sub>i</sub>, x<sub>j</sub>) &ge; 0
     * 
     * @param kf
     */
    ...
    /**
     * Returns the square of the distance function expanded as kernel methods. <br>
