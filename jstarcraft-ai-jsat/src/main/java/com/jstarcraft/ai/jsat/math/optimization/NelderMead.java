...
public class NelderMead implements Optimizer {
    ...
    /**
     * Sets the expansion constant, which must be greater than 1 and the reflection
     * constant
     * 
     * @param expansion
     */
     ...
     * @param iterationLimit the maximum number of iteration steps to allow. This
     *                       value must be positive
     * @param f              the function to optimize. This value can not be null
     * @param initalPoints   the list of initial guess points. If too small, new
     *                       ones will be generated. if too large, the extra ones
     *                       will be ignored. This list may not be empty
     * @param parallel       {@code true} if multiple threads should be used for
     *                       optimization, or {@code false} if a single thread
     *                       should be used.
