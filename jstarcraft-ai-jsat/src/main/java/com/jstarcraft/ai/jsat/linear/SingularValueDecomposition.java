...
import static com.jstarcraft.ai.jsat.linear.RowColumnOps.addMultCol;
import static com.jstarcraft.ai.jsat.linear.RowColumnOps.divCol;
import static com.jstarcraft.ai.jsat.linear.RowColumnOps.multCol;
import static com.jstarcraft.ai.jsat.linear.RowColumnOps.swapCol;
 ...
 * U<sub>m,n </sub> &Sigma;<sub>n,n </sub> V<sup>T</sup><sub>n,n </sub>, where S
...
public class SingularValueDecomposition implements Cloneable, Serializable {
    ...
    /**
     * Creates a new SVD of the matrix {@code A} such that A = U &Sigma;
     * V<sup>T</sup>. The matrix {@code  A} will be modified and used as temp space
     ...
     * 
     * @param A             the matrix to create the SVD of
     * @param maxIterations the maximum number of iterations to perform per singular
     ...
     * zero ones.
     * 
     * @return a copy of the sorted array of the singular values, including the near
     *         zero ones.
     */
    ...
    /**
     * Returns the numerical rank of the matrix. Values &lt;= than <tt>tol</tt> will
     * be ignored.
     * 
    ...
    /**
     * Returns an array containing the inverse singular values. Near zero values are
     * converted to zero.
     * 
    ...
    /**
     * Computes the pseudo determinant of the matrix, which corresponds to absolute
     * value of the determinant of the full rank square sub matrix that contains all
