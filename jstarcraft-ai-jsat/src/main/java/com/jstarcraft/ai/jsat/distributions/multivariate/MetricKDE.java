...
public class MetricKDE extends MultivariateKDE implements Parameterized {
     ...
     * from the mean to add to the bandwidth estimate is {@value #DEFAULT_STND_DEV}
     */
     ...
     * @param distanceMetric the distance metric to use
     * @param vc             a factory to generate vector collection from
     * @param defaultK       the default neighbor to use when estimating the
     *                       bandwidth
     * @param defaultStndDev the default multiple of standard deviations to add when
     ...
     * distribution. Too small a bandwidth results in high variance, while too large
     * causes high bias.
     * 
    ...
    /**
     * When estimating the bandwidth, the mean of the k'th nearest neighbors to each
     * data point is used. This value controls the default value of k used when it
     * is not specified.
     * 
     * @param defaultK
     */
     ...
     * multiplier value used when the bandwidth is not specified. Zero and negative
     * multipliers are allowed, but a negative multiplier may result in the fitting
     * failing.
     * 
     * @param defaultStndDev the multiple of the standard deviation to add the to
     *                       bandwidth estimate
     */
     ...
     * @return <tt>true</tt> if the model was fit, <tt>false</tt> if it could not be
     *         fit.
     */
    ...
    /**
     * Sets the KDE to model the density of the given data set by estimating the
     * bandwidth by using the <tt>k</tt> nearest neighbors of each data data point.
     * <br>
     * The bandwidth estimate is calculate as the mean of the distances of the k'th
     * nearest neighbor plus <tt>stndDevs</tt> standard deviations added to the
     * mean.
     * 
     * @param dataSet  the data set to model the density of
     * @param k        the number of neighbors to use to estimate the bandwidth
     * @param stndDevs the multiple of the standard deviation to add to the mean of
     *                 the distances
     * @return <tt>true</tt> if the model was fit, <tt>false</tt> if it could not be
     *         fit.
     */
     ...
     * @param dataSet    the data set to model the density of
     * @param k          the number of neighbors to use to estimate the bandwidth
     * @param stndDevs   the multiple of the standard deviation to add to the mean
     *                   of the distances
