...
public class DDAG extends OneVSOne {
     ...
     *                        classifiers occur in parallel, <tt>false</tt> to have
     *                        them use their native parallel training method.
     */
    ...
    public CategoricalResults classify(DataPoint data) {
        ...
        // Use a priority que so that we always pick the two lowest value class labels,
        // makes indexing into the oneVsOne array simple
        ...
        int c1, c2;
        // We will now loop through and repeatedly pick two combinations, and eliminate
        // the loser, until there is one winer
