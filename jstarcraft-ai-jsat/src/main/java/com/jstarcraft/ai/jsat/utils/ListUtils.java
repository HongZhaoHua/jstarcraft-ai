...
public class ListUtils {
     ...
     * the source list. <br>
     * <br>
     * <b>NOTE</b>: Because the implementation uses {@link List#subList(int, int) },
    ...
    /**
     * Obtains a random sample without replacement from a source list and places it
     * in the destination list. This is done without modifying the source list.
     * 
     ...
     * This random sampling is oblivious to failures to add to a collection that may
     * occur, such as if the collection is a {@link Set}
     * 
     * @param         <T> the list content type involved
     * @param source  the source of values to randomly sample from
     * @param dest    the collection to store the random samples in. It does not
     *                need to be empty for the sampling to work correctly
     * @param samples the number of samples to select from the source
     * @param rand    the source of randomness for the sampling
     * @throws IllegalArgumentException if the sample size is not positive or l
