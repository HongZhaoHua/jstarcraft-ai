...
public class FastMath {
    ...
    /**
     * Computes log<sub>2</sub>(x) using a cache of 2<sup>11</sup> values, consuming
     * approximately 17 kilobytes of memory.<br>
     * The results are generally accurate to an absolute and relative error of
     * 10<sup>-4</sup>
     * 
     * @param x the input
    ...
    public static double pow(double a, double b) {
        ...
        /*
         * Wright out a^b as 2^(b log2(a)) and then replace a with 'm 2^e' to get 2^(b *
         * log2(m*2^e)) which simplifies to m^b 2^(b e) when m, e, and b are positive.
         * 
        ...
        // we end up with 2^(b * log_2(m)) * 2^(b * e), which we can reduce to a single
        // pow2 call
    ...
    public static double digamma(double x) {
        ...
        /*
         * shift over 2 values to the left and use truncated approximation log(x+2)-1/(2
         * (x+2))-1/(12 (x+2)^2) -1/x-1/(x+1), the x+2 and x and x+1 are grouped
         * sepratly
         */
        double xp2 = x + 2;
