...
public interface Optimizer {
     ...
     * that will minimize the value returned by {@code f(w)}, using <i>w =
     * x<sub>0</sub></i> as an initial starting point.
     * 
     ...
     *                  changed, and intermediate matrices will be created as the
     *                  same type.
     * @param f         the objective function to minimizer
     * @param fp        the derivative of the objective function, may be
     *                  {@code null} depending on the optimizer
     */
     ...
     *                  optimization, or {@code false} if a single thread should be
     *                  used.
     */
