...
import static com.jstarcraft.ai.jsat.distributions.DistributionSearch.getBestDistribution;
...
import com.jstarcraft.ai.jsat.distributions.DistributionSearch;
...
public class NaiveBayes implements Classifier, Parameterized {
    ...
    public enum NumericalHandeling {
        ...
        /**
         * The best fitting {@link ContinuousDistribution} is selected by
         * {@link DistributionSearch#getBestDistribution(jsat.linear.Vec, double) }, and
         * provides a cut off value to use the {@link KernelDensityEstimator} instead
         */
        BEST_FIT_KDE {
...
//            }
    ...
    /**
     * Sets the method used by this instance for handling numerical attributes. This
     * has no effect on an already trained classifier, but will change the result if
     * trained again.
     * 
     ...
     * This allows faster, more efficient computation of results if the data points
     * are indeed sparce. This will also produce different results. This value
     * should not be changed after training and before classification.
     * 
     * @param sparceInput <tt>true</tt> to assume sparseness in the data,
     *                    <tt>false</tt> to ignore it and assume zeros are
     *                    meaningful values.
     * @see #isSparceInput()
     */
    ...
    private class AprioriCounterRunable implements Runnable {
        ...
        public void run() {
            ...
            // Convert the coutns to apriori probablities by dividing the count by the total
            // occurances
            double sum = 0;
