...
public class HuberLoss implements LossR {
    ...
    public double lipschitz() {
        ...
        // We also observe that |fc''(x)| ≤ 1/c. This implies that fc(x) is
        // 1/c-Lipschitz continuous.
        // Huber interpolated between Asbolute loss and Squared loss, with are both
        // L-Lipschitz, so Huber is too
        return 1;
    }
}
