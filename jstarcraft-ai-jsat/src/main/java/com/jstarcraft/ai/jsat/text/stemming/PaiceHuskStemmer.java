...
public class PaiceHuskStemmer extends Stemmer {
    ...
    static private class Rule {
         ...
         * modification was done, the exact same string that was passed in is returned.
         * An object comparison can then be done to check if the string was modified.
         * <br>
    ...
    /*
     * Oreded alphabetically by ending, meaning the rules should be attempted in the
     * order they are presented in the array
     */
