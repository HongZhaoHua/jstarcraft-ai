package com.jstarcraft.ai.jsat.classifiers.evaluation;
...
public interface ClassificationScore extends Serializable {
     ...
     * averaging, but alters the current object to have the same score it would have
     * had if all the results were originally inserted into <i>this </i> object.
     * <br>
     * <br>
     * This method is only required to work if {@code other} if of the same class as
     * {@code this} object.
     * 
     ...
     * {@link #addResult(com.jstarcraft.ai.jsat.classifiers.CategoricalResults, int, double) }
     * 
    ...
    /**
     * Returns {@code true} if a lower score is better, or {@code false} if a higher
     * score is better
     * 
