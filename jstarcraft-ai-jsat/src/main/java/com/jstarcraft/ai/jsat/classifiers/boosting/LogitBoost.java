...
public class LogitBoost implements Classifier, Parameterized {
    ...
    /**
     * Sets the maximum number of iterations of boosting that can occur, giving the
     * maximum number of base learners that may be trained
     * 
     ...
     * @throws ArithmeticException if the value is not in (0,
    ...
    public void train(ClassificationDataSet dataSet, boolean parallel) {
        ...
        /**
         * The data points paired with what we will use to store the target regression
         * values.
         */
