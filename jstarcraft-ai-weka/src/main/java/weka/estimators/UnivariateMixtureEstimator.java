...
/**
 * Simple weighted mixture density estimator. Uses a mixture of Gaussians and
 * applies the leave-one-out bootstrap for model selection. Can alternatively
...
public class UnivariateMixtureEstimator implements UnivariateDensityEstimator, UnivariateIntervalEstimator, UnivariateQuantileEstimator, OptionHandler, Serializable {
    ...
    public class MM {
        ...
        /**
         * Returns smallest distance to given elements. Assumes m_Means has at least one
         * element (i.e. m_K >= 1).
         */
        ...
        /**
         * Returns the index of the nearest mean. Assumes m_Means has at least one
         * element (i.e. m_K >= 1).
         */
        ...
        /**
         * Initializes the model. Assumes K >= 1, values.length >= 1, and values.length
         * = weights.length.
         */
    ...
    /**
     * The number of Bootstrap runs to use to select the number of components
     * (default is 10)
     */
    ...
    /**
     * Build mixture model. Assumes K >= 1, values.length >= 1, and values.length =
     * weights.length.
     */
    ...
    /**
     * Selects the number of components using leave-one-out Bootstrap, estimating
     * loglikelihood.
     *
    ...
    /**
     * Updates the model based on the current data. Uses the leave-one-out Bootstrap
