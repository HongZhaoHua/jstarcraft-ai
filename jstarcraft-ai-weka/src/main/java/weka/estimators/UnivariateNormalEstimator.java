...
public class UnivariateNormalEstimator implements UnivariateDensityEstimator, UnivariateIntervalEstimator, UnivariateQuantileEstimator, Serializable {
    ...
    /**
     * Updates mean and variance based on sufficient statistics. Variance is set to
     * m_MinVar if it becomes smaller than that value. It is set to Double.MAX_VALUE
