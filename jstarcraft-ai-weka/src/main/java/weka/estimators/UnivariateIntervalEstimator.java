...
/**
 * Interface that can be implemented by simple weighted univariate interval
 * estimators.
 *
...
public interface UnivariateIntervalEstimator {
    ...
    /**
     * Returns the intervals at the given confidence value. Each row has one
     * interval. The first element in each row is the lower bound, the second
     * element the upper one.
     *
