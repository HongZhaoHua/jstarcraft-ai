...
/**
 * <!-- globalinfo-start --> Reweights the instances in the data so that each
 * class has the same total weight. The total sum of weights accross all
 * instances will be maintained. Only the weights in the first batch of data
 * received by this filter are changed, so it can be used with the
 * FilteredClassifier. If the class is numeric, it is discretized using
 * equal-width discretization to establish pseudo classes for weighting.
 * <p/>
 * <!-- globalinfo-end -->
 * 
