...
public class NominalToBinary extends Filter implements UnsupervisedFilter, OptionHandler, StreamableFilter, WeightedAttributesHandler, WeightedInstancesHandler {
    ...
    /**
     * If true, when generating binary attributes, spread weight of old attribute
     * across new attributes. Do not give each new attribute the old weight.
     *
    ...
    /**
     * Gets if all nominal values are turned into new attributes, not only if there
     * are more than 2.
     * 
    ...
    /**
     * Sets whether all nominal values are transformed into new attributes, not just
    ...
    /**
     * Sets whether selected columns should be removed or kept. If true the selected
