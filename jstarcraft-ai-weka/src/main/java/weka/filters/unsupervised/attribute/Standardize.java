...
/**
 * <!-- globalinfo-start --> Standardizes all numeric attributes in the given
 * dataset to have zero mean and unit variance (apart from the class attribute,
 * if set).
 * <p/>
 * <!-- globalinfo-end -->
 *
 ...
 * @version $Revision$
 */
public class Standardize extends PotentialClassIgnorer implements UnsupervisedFilter, Sourcable, WeightedAttributesHandler, WeightedInstancesHandler {
