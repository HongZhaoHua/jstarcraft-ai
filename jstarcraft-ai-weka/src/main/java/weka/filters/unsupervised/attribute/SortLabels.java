...
public class SortLabels extends SimpleStreamFilter implements WeightedInstancesHandler, WeightedAttributesHandler {
    ...
    public static class CaseSensitiveComparator implements Comparator<String>, Serializable {
        ...
        /**
         * compares the two strings, returns -1 if o1 is smaller than o2, 0 if equal and
         * +1 if greater.
         * 
    ...
    public final static Tag[] TAGS_SORTTYPE = { new Tag(SORT_CASESENSITIVE, "case", "Case-sensitive"), new Tag(SORT_CASEINSENSITIVE, "non-case", "Case-insensitive") };
