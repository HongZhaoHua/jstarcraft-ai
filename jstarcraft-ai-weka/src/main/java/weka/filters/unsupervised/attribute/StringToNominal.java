 ...
 * @version $Revision$
 */
public class StringToNominal extends Filter implements UnsupervisedFilter, OptionHandler, WeightedAttributesHandler, WeightedInstancesHandler {
     ...
     * @throws UnsupportedAttributeTypeException if the selected attribute a string
     *                                           attribute.
    ...
    public String attributeRangeTipText() {
        ...
        return "Sets which attributes to process (\"first\" and \"last\" are valid values " + "and ranges and lists can also be used).";
    }
