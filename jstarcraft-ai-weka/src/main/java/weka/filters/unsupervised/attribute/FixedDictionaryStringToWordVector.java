...
public class FixedDictionaryStringToWordVector extends SimpleStreamFilter implements UnsupervisedFilter, EnvironmentHandler, WeightedInstancesHandler {
    ...
    /**
     * Set an input stream to load a binary serialized dictionary from, rather than
     * source it from a file
     *
    ...
    /**
     * Set an input reader to load a textual dictionary from, rather than source it
     * from a file
     *
