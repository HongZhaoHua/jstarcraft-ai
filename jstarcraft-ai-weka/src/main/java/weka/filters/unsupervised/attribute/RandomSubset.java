...
/**
 * <!-- globalinfo-start --> Chooses a random subset of non-class attributes,
 * either an absolute number or a percentage. Attributes are included in the
 * order in which they occur in the input data. The class attribute (if present)
...
public class RandomSubset extends SimpleBatchFilter implements Randomizable, WeightedInstancesHandler, WeightedAttributesHandler {
    ...
    /**
     * Set whether to invert the selection - i.e. randomly remove rather than select
     * attributes.
     * 
    ...
    /**
     * Get whether to invert the selection - i.e. randomly remove rather than select
     * attributes.
     * 
     ...
     * <p/>
     *
     * @return true for this filter so that input data can affect subset of
     *         attributes that is selected
     */
    ...
    protected Instances determineOutputFormat(Instances inputFormat) throws Exception {
        ...
        // Get a random number generator that depends on the particular dataset passed
        // in
