...
/**
 * <!-- globalinfo-start --> Centers all numeric attributes in the given dataset
 ...
 * @version $Revision$
 */
public class Center extends PotentialClassIgnorer implements UnsupervisedFilter, Sourcable, WeightedInstancesHandler, WeightedAttributesHandler {
