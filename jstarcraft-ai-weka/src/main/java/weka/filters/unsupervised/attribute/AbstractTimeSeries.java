...
public abstract class AbstractTimeSeries extends Filter implements UnsupervisedFilter, OptionHandler, WeightedAttributesHandler, WeightedInstancesHandler {
    ...
    /**
     * Gets the number of instances forward to translate values between. A negative
     * number indicates taking values from a past instance.
     * 
    ...
    /**
     * Sets the number of instances forward to translate values between. A negative
     * number indicates taking values from a past instance.
     * 
     ...
     * are copied and unselected columns are kept.
     * 
     ...
     * 
     * @param instance the input instance
     * @return a new instance with translated values, or null if no output instance
     *         is produced
     */
