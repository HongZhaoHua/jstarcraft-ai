...
public class RemoteEngine extends UnicastRemoteObject implements Compute, RevisionHandler {
    ...
    public RemoteEngine(String hostName) throws RemoteException {
        ...
        /*
         * launch a clean-up thread. Will purge any failed or finished tasks still in
         * the TaskStatus hashtable after an hour
         */
    ...
    /**
     * Attempts to purge class types from the virtual machine. May take some time as
     * it relies on garbage collection
     */
     ...
     * for an @seeCLEANUPTIMEOUT or more are removed. Clients are expected to check
     ...
     * and binds it in the RMI registry. If there is no RMI registry, then it tries
     * to create one with default port 1099.
     * 
     * @param args
     */
