 ...
 * written to an individually named gzip file. If the destination file is a
 * file, then each output string is appended as a named entry to the zip file
 * until finished() is called to close the file.
 *
...
public class OutputZipper implements RevisionHandler {
    ...
    /**
     * Saves a string to either an individual gzipped file or as an entry in a zip
     * file.
     * 
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /*
             * OutputZipper oz = new OutputZipper( new
