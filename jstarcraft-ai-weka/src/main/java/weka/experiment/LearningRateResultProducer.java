...
public class LearningRateResultProducer implements ResultListener, ResultProducer, OptionHandler, AdditionalMeasureProducer {
    ...
    /**
     * The minimum number of instances to use. If this is zero, the first step will
     * contain m_StepSize instances
     */
    ...
    public void doRun(int run) throws Exception {
        ...
        /*
         * if (runInstances.classAttribute().isNominal() && (m_Instances.numInstances()
         * / m_StepSize >= 1)) { // runInstances.stratify(m_Instances.numInstances() /
         * m_StepSize); }
         */
