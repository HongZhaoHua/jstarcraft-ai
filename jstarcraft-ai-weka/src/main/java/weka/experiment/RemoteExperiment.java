...
public class RemoteExperiment extends Experiment {
    ...
    /**
     * Set to true if MAX_FAILURES exceeded on all hosts or connections fail on all
     * hosts or user aborts experiment (via gui)
     */
     ...
     *         to be created on the basis of data set (true) or run number (false).
     */
     ...
     * 
     * @param sd true if sub experiments are to be created on the basis of data set.
     *           Otherwise sub experiments are created on the basis of run number.
     */
    ...
    /**
     * Add an object to the list of those interested in recieving update information
     * from the RemoteExperiment
     * 
     * @param r a listener
     */
    ...
    /**
     * Set the base experiment. A sub experiment will be created for each run in the
     * base experiment.
     * 
     * @param base the base experiment to use.
    ...
    /**
     * Pushes a host back onto the queue of available hosts and attempts to launch a
     * waiting experiment (if any).
     * 
     * @param hostNum the index of the host to push back onto the queue of available
     *                hosts
     */
