...
public abstract class AbstractClusterer implements Clusterer, Cloneable, Serializable, CapabilitiesHandler, RevisionHandler, OptionHandler, CapabilitiesIgnorer, CommandlineRunnable {
     ...
     * 
     * -D <br>
     * If set, clusterer is run in debug mode and may output additional info to the
     * console.
     * <p>
     * 
     * -do-not-check-capabilities <br>
     * If set, clusterer capabilities are not checked before clusterer is built (use
     * with caution).
     * <p>
     * 
     ...
     * OptionHandler and the options parameter is non-null, the clusterer will have
     * it's options set.
     * 
