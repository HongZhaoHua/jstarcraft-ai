...
public class HierarchicalClusterer extends AbstractClusterer implements OptionHandler, Drawable {
    ...
    public static final Tag[] TAGS_LINK_TYPE = { new Tag(SINGLE, "SINGLE"), new Tag(COMPLETE, "COMPLETE"), new Tag(AVERAGE, "AVERAGE"), new Tag(MEAN, "MEAN"), new Tag(CENTROID, "CENTROID"), new Tag(WARD, "WARD"), new Tag(ADJCOMPLETE, "ADJCOMPLETE"), new Tag(NEIGHBOR_JOINING, "NEIGHBOR_JOINING") };
     ...
     * with the closest distance to the instance to be clustered. The cluster index
     * of the training data point is taken as the cluster index.
     */
    ...
    public String distanceFunctionTipText() {
        return "Sets the distance function, which measures the distance between two individual. " + "instances (or possibly the distance between an instance and the centroid of a cluster" + "depending on the Link type).";
    }
