...
public class Sorter extends BaseStep {
    ...
    /**
     * The directory to hold the temp files - if not set the system tmp directory is
     * used
     */
    ...
    protected static class InstanceHolder implements Serializable {
        ...
        /**
         * for incremental operation, if string attributes are present then we need to
         * store them with each instance - since incremental streaming in the knowledge
         * flow only maintains one string value in memory (and hence in the header) at
         * any one time
         */
    ...
    protected static class SortComparator implements Comparator<InstanceHolder> {
         ...
         * @return the result of the comparison - the first rule that returns a non-zero
         *         comparison value
         */
        @Override
    ...
    public static class SortRule implements Comparator<InstanceHolder> {
         ...
         * @param structure the structure of the instances that the rule will opperate
         *                  on
         */
