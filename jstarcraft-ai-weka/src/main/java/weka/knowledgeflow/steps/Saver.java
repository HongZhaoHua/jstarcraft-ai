...
public class Saver extends WekaAlgorithmWrapper implements Serializable {
    ...
    /**
     * Get the saver instance that is wrapped by this step. Convenience method that
     * delegates to {@code getWrappedAlgorithm()}
     *
    ...
    /**
     * Set the saver instance that is wrapped by this step. Convenience method that
     * delegates to {@code setWrappedAlgorithm()}.
     *
    ...
    /**
     * Set whether to use the relation name as the primary part of the filename. If
     * false, then the prefix becomes the filename.
     *
     ...
     * and colons with underscores ("_"). Also try to prevent filename from becoming
     * insanely long by removing package part of class names.
     * 
