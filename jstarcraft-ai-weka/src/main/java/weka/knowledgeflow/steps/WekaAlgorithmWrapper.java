...
public abstract class WekaAlgorithmWrapper extends BaseStep implements Serializable {
    ...
    /**
     * Get the default icon at the package level for this type of wrapped algorithm
    ...
    /**
     * Get the default icon for this type of wrapped algorithm (i.e. generic Loader,
     * Saver etc.
     * 
