...
public class Clusterer extends WekaAlgorithmWrapper implements PairedDataHelper.PairedProcessor<weka.clusterers.Clusterer> {
    ...
    /**
     * Get the name of the clusterer to load at execution time. This only applies in
     * the case where the only incoming connection is a test set connection (batch
     * mode) or an instance connection (incremental prediction mode).
     *
    ...
    /**
     * Set the name of the clusterer to load at execution time. This only applies in
     * the case where the only incoming connection is a test set connection (batch
     * mode) or an instance connection (incremental prediction mode).
     *
    ...
    /**
     * Get a list of connection types that could be made to this Step at this point
     * in time
     *
    ...
    /**
     * Get a list of outgoing connections that could be made from this step at this
     * point in time
     *
    ...
    /**
     * Output a Data object containing a dot graph, if the model is Drawable and we
     * have downstream steps receiving graph connections.
     *
