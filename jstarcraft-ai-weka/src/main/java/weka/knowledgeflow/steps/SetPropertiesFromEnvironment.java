...
public class SetPropertiesFromEnvironment extends BaseStep {
    ...
    /**
     * Gets the property descriptor for the supplied property name on the supplied
     * target object
     *
     * @param target   the target object
     * @param propName the property name
    ...
    /**
     * Drill down to the last element in the supplied property path list on the
     * given base object
     *
