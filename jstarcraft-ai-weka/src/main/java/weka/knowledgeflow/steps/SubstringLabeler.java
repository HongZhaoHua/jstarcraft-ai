...
public class SubstringLabeler extends BaseStep {
    ...
    /**
     * Set whether instances that do not match any of the rules should be "consumed"
     * rather than output with a missing value set for the new attribute.
     *
    ...
    /**
     * Get whether instances that do not match any of the rules should be "consumed"
     * rather than output with a missing value set for the new attribute.
     *
