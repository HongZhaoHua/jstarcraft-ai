 ...
 * connection. Gets used programmatically when the setInstances() method is
 * invoked on the MainKFPerspective in order to create a new Flow containing
 * this step.
 *
 * @author Mark Hall (mhall{[at]}pentaho{[dot]}com)
 * @version $Revision: $
 */
@KFStep(name = "MemoryDataSource", category = "DataSources", toolTipText = "Memory-based data", iconPath = KFGUIConsts.BASE_ICON_PATH + "DefaultDataSource.gif")
