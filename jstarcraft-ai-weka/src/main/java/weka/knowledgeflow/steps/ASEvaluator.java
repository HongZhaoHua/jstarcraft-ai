...
public class ASEvaluator extends WekaAlgorithmWrapper {
     ...
     *                       search with subset evaluator or regular search with
     *                       attribute evaluator
     */
    @Override
    ...
    /**
     * Apply a filter to reduce the dimensionality of the supplied data. Outputs the
     * reduced data to downstream steps on the given connection type
     *
    ...
    /**
     * Get a list of output connections that can be produced given the current state
     * of the step
     *
