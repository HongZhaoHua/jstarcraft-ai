 ...
 * @version $Revision: $
 */
@KFStep(name = "AlterRelationName", category = "Flow", toolTipText = "Alter the relation name in data sets", iconPath = KFGUIConsts.BASE_ICON_PATH + "DiamondPlain.gif")
public class AlterRelationName extends BaseStep {
    ...
    /**
     * Get the list of outgoing connection types that can be made given the current
     * state of incoming connections
     *
