 ...
 * @version $Revision: $
 */
@KFStep(name = "IncrementalClassifierEvaluator", category = "Evaluation", toolTipText = "Evaluate the performance of incrementally training classifiers", iconPath = KFGUIConsts.BASE_ICON_PATH + "IncrementalClassifierEvaluator.gif")
public class IncrementalClassifierEvaluator extends BaseStep {
    ...
    /**
     * window size for computing performance metrics - 0 means no window, i.e don't
     * "forget" performance on any instances
     */
     ...
     *                   metrics used for charting. Setting a value of zero or less
     *                   specifies that no windowing is to be used.
     */
     ...
     *         used for charting. Setting a value of zero or less specifies that no
