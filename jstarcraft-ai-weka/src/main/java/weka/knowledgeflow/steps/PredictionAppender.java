 ...
 * @version $Revision: $
 */
@KFStep(name = "PredictionAppender", category = "Evaluation", toolTipText = "Append predictions from classifiers or clusterers to incoming data ", iconPath = KFGUIConsts.BASE_ICON_PATH + "PredictionAppender.gif")
public class PredictionAppender extends BaseStep {
     ...
     * @param distribution         true if a distribution over cluster labels will
     *                             be predicted
