 ...
 * @version $Revision: $
 */
@KFStep(name = "TrainingSetMaker", category = "Evaluation", toolTipText = "Make an incoming dataSet or testSet into a trainingSet", iconPath = KFGUIConsts.BASE_ICON_PATH + "TrainingSetMaker.gif")
public class TrainingSetMaker extends BaseStep {
    ...
    public List<String> getIncomingConnectionTypes() {
        if (getStepManager().numIncomingConnections() == 0) {
            return Arrays.asList(StepManager.CON_DATASET, StepManager.CON_TESTSET);
        }
