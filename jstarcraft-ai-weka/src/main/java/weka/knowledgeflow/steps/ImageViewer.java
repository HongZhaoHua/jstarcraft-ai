 ...
 * @version $Revision: $
 */
@KFStep(name = "ImageViewer", category = "Visualization", toolTipText = "View images", iconPath = KFGUIConsts.BASE_ICON_PATH + "StripChart.gif")
public class ImageViewer extends BaseStep implements DataCollector {
    ...
    /**
     * Get a list of acceptable incoming connections - only StepManager.CON_IMAGE in
     * this case
     * 
    ...
    /**
     * Gets a list of classes of viewers that can be popped up in the GUI Knowledge
     * Flow from this step, given that we have received and stored some image data.
     *
    ...
    /**
     * Utility method to convert a map of {@code byte[]} png image data to a map of
     * {@code BufferedImage}
     *
