...
public class FlowByExpression extends BaseStep {
    ...
    public static abstract class ExpressionNode implements Serializable {
         ...
         * @return the remaining parts of the expression after parsing and removing the
         *         part for this node
         */
    ...
    public static class ExpressionClause extends ExpressionNode implements Serializable {
         ...
         * @param isAnOr           true if the result of this expression is to be OR'ed
        ...
        protected String parseFromInternal(String expression) {
            ...
            expression = expression.substring(expression.indexOf(']') + 1, expression.length()); // remove
                                                                                                 // "]"
            if (expression.charAt(0) == ' ') {
                expression = expression.substring(1, expression.length());
            }
