...
public class CrossValidationFoldMaker extends BaseStep {
    ...
    /**
     * Set whether to preserve the order of the input instances when creatinbg the
     * folds
     *
    ...
    /**
     * Get whether to preserve the order of the input instances when creatinbg the
     * folds
     *
