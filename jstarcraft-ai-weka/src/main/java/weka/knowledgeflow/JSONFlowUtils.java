...
public class JSONFlowUtils {
    ...
    /**
     * Checks a property to see if it is tagged with the FilePropertyMetadata class.
     * If so, it converts the string property into an actual file property so that
     * the Step can be restored correctly
     * 
     ...
     * @throws WekaException if a problem occurs
     */
    protected static void readConnectionsForStep(JSONNode step, Flow flow) throws WekaException {
    ...
    /**
     * Serializes the supplied flow to JSON and writes out using the supplied output
     * stream
     *
     * @param flow the {@code Flow} to serialize
     ...
     *                                            raised if connections are missing
     *                                            in the flow
     ...
     * 
     * @param flowJSON                            the string containing a flow in
     *                                            JSON form
     * @param dontComplainAboutMissingConnections to not raise any exceptions if
     *                                            there are missing connections in
     *                                            the flow
     * @return the deserialized flow
     * @throws WekaException if a problem occurs
     */
