 ...
 * data items can be added via the setPayloadElement() method.
 * </p>
 * 
 * <p>
 * Standard connection types are defined as constants in the StepManager class.
 * There is nothing to prevent clients from using their own connection types (as
 * these are just string identifiers).
 * </p>
 *
 * Typical usage in a client step (transferring an training instances
 * object):<br>
 * <br>
 * 
 * <pre>
...
public class Data implements Serializable {
     ...
     * @return the primary payload data (or null if there is no data associated with
     *         the connection)
     */
     ...
     * @return the named payload element, or null if it does not exist in this Data
     *         object
     */
    @SuppressWarnings("unchecked")
