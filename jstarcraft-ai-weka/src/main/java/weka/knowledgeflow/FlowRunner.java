...
public class FlowRunner implements FlowExecutor, CommandlineRunnable {
    ...
    protected int m_numThreads = BaseExecutionEnvironment.BaseExecutionEnvironmentDefaults.STEP_EXECUTOR_SERVICE_NUM_THREADS;

    /**
     * Number of worker threads to use in the resource intensive executor service
     */
    protected int m_resourceIntensiveNumThreads = BaseExecutionEnvironment.BaseExecutionEnvironmentDefaults.RESOURCE_INTENSIVE_EXECUTOR_SERVICE_NUM_THREADS;
    ...
    protected void runSequentially(List<StepManagerImpl> startPoints) throws WekaException {
        ...
        for (final StepManagerImpl stepToStart : sortedStartPoints.values()) {
             ...
             * 
             * @Override public void process() throws Exception { stepToStart.startStep(); }
             * });
             */
        }
