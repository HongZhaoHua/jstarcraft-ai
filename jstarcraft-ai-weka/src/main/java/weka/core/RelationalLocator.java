...
public class RelationalLocator extends AttributeLocator {
    ...
    /**
     * Initializes the RelationalLocator with the given data. Checks only the given
     * range.
     * 
     * @param data      the data to work on
     ...
     * @param strAtts     an AttributeLocator containing the indices of any
     *                    relational attributes in the dataset.
     */
     ...
     * source dataset to a destination dataset. The instance references are updated
     * to be valid for the destination dataset. The instance may have the structure
     * (i.e. number and attribute position) of either dataset (this affects where
     * references are obtained from). Only works if the number of relational
     * attributes is the same in both indices (implicitly these relational
     ...
     *                      source dataset that will have references updated to be
     *                      valid for the destination dataset.
     ...
     *                      (i.e. which of the relational attribute indices contains
     *                      the correct locations for this instance).
     * @param srcDataset    the dataset for which the current instance relationvalue
     *                      references are valid (after any position mapping if
     *                      needed)
     ...
     *                      references need to be inserted (after any position
     *                      mapping if needed)
