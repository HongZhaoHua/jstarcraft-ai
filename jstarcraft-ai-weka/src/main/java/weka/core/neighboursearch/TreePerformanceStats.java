...
public class TreePerformanceStats extends PerformanceStats {
    ...
    /**
     * The min and max number leaf nodes looked for a query by the tree based NNS
     * algorithm.
     */
    ...
    /**
     * The min and max number internal nodes looked for a query by the tree based
     * NNS algorithm.
     */
    ...
    /**
     * Signals end of the nearest neighbour search. Calculates the statistics for
     * the search.
     */
     ...
     * 
     * @return The mean number of internal nodes visited.
     */
