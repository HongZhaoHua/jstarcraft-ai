...
public abstract class BallTreeConstructor implements OptionHandler, Serializable, RevisionHandler {
     ...
     *                   tree.
     */
    public abstract int[] addInstance(BallNode node, Instance inst) throws Exception;
     ...
     * radius of the smallest ball enclosing all the data points (that were used to
     * build the tree). This smallest ball would be the same as the root node's
