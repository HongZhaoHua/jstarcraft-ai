...
public class SerialUIDChanger implements RevisionHandler {
     ...
     * 
     * @param binary the filename that points to the file containing the serialized
     *               object
    ...
    /**
     * exchanges an old UID for a new one. a file that doesn't end with ".koml" is
     * considered being binary. takes four arguments: oldUID newUID oldFilename
     * newFilename
     * 
