...
public class StringLocator extends AttributeLocator {
     ...
     * valid for the destination dataset. The instance may have the structure (i.e.
     * number and attribute position) of either dataset (this affects where
     * references are obtained from). Only works if the number of string attributes
     * is the same in both indices (implicitly these string attributes should be
     * semantically same but just with shifted positions).
     * 
     * @param instance      the instance containing references to strings in the
     ...
     *                      (i.e. which of the string attribute indices contains the
