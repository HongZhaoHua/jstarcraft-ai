 ...
 *
 * @author Ashraf M. Kibriya(amk14@cs.waikato.ac.nz), Eibe
...
public interface Drawable {
    ...
    /**
     * Returns a string that describes a graph representing the object. The string
     * should be in XMLBIF ver. 0.3 format if the graph is a BayesNet, otherwise it
     * should be in dotty format.
     *
