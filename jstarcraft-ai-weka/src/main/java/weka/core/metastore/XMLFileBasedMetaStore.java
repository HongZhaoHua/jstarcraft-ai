...
public class XMLFileBasedMetaStore implements MetaStore {
    ...
    public static final String DEFAULT_STORE_LOCATION = ResourceUtils.getWekaHome().toString() + File.separator + "wekaMetaStore";
    ...
    /**
     * Gets a serializer to use. Creates a subclass of {@code XMLBasicSerialization}
     * that has allowed properties set for common option handlers.
     * 
