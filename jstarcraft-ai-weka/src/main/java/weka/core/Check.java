...
public abstract class Check implements OptionHandler, RevisionHandler {
    ...
    /**
     * Tries to instantiate a new instance of the given class and checks whether it
     * is an instance of the specified class. For convenience one can also specify a
     * classname prefix (e.g., "weka.classifiers") to avoid long classnames and then
     * instantiate it with the shortened classname (e.g., "trees.J48").
     * 
