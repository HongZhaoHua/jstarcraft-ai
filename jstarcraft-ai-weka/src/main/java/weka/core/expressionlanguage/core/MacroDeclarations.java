 ...
 * </p>
 * 
 * It is deliberately kept very simple to give as little constraints as possible
 * to implementations.
 * </p>
 * 
 * There is an implied invariant here:</br>
 * <code>{@link #hasMacro(String)} == true ->
 * {@link #getMacro(String)} != null</code>
 * </p>
 * 
...
public interface MacroDeclarations {
     ...
     * </p>
     * 
     * Before a macro is fetched it shold be checked whether it is declared through
     * {@link #hasMacro(String)}
     * 
     * @param name
     * @return
     */
