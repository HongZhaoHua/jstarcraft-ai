...
public class Primitives implements Serializable {
     ...
     * implement one primitive type it's easy to determine whether the ifelse macro
     * can be evaluated. If parameters could implement two types simultaneously it
     * wouldn't be clear which one should be chosen/preferred.
     */
