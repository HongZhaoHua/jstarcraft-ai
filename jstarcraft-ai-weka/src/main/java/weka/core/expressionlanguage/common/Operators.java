...
public class Operators {
    ...
    private static abstract class DoubleBinaryExpression implements DoubleExpression, Serializable {
    ...
    private static abstract class BooleanBinaryExpression<T> implements BooleanExpression, Serializable {
    ...
    private static class LessThan extends BooleanBinaryExpression<DoubleExpression> implements Serializable {
    ...
    private static class LessEqual extends BooleanBinaryExpression<DoubleExpression> implements Serializable {
    ...
    private static class GreaterThan extends BooleanBinaryExpression<DoubleExpression> implements Serializable {
    ...
    private static class GreaterEqual extends BooleanBinaryExpression<DoubleExpression> implements Serializable {
    ...
    private static class Equal extends BooleanBinaryExpression<DoubleExpression> implements Serializable {
    ...
    private static class And extends BooleanBinaryExpression<BooleanExpression> implements Serializable {
    ...
    private static class Or extends BooleanBinaryExpression<BooleanExpression> implements Serializable {
    ...
    private static class Is extends BooleanBinaryExpression<StringExpression> implements Serializable {
    ...
    private static class Regexp extends BooleanBinaryExpression<StringExpression> implements Serializable {
    ...
    private static class CompiledRegexp implements BooleanExpression, Serializable {
