 ...
 * <p/>
 * <a href="http://bib2web.djvuzone.org/bibtex.html" target=
 * "_blank">http://bib2web.djvuzone.org/bibtex.html</a>
 * 
...
public class TechnicalInformation implements RevisionHandler {
    ...
    public enum Field {
         ...
         * publishing houses, van Leunen recommends omitting the information entirely.
         * For small publishers, on the other hand, you can help the reader by giving
         ...
         * which it was written. You should use the standard three-letter abbreviation,
         ...
         * and number; the organization that issues a technical report usually gives it
         * a number; and sometimes books are given numbers in a named series.
         */
         ...
         * title field gives its title and an optional series field gives the name of a
         ...
         * standard styles can handle any year whose last four nonpunctuation characters
    ...
    /**
     * the unique identifier of this information, will be generated automatically if
     * left empty
     */
    ...
    /**
     * Generates an ID based on the current settings and returns it. If nothing can
     * be generated the MISSING_ID string will be returned
     * 
     * @return the ID
     * @see #MISSING_ID
     */
    ...
    /**
     * returns TRUE if the field is stored and has a value different from the empty
     * string.
     * 
    ...
    /**
     * returns an enumeration of all the additional technical informations (if there
     * are any)
     * 
    ...
    /**
     * Returns a plain-text string representing this technical information. Note: it
     * only returns a string based on some fields. At least AUTHOR, YEAR and TITLE
     * are necessary.
     * 
