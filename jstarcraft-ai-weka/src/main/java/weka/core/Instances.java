...
public class Instances extends AbstractList<Instance> implements Serializable, RevisionHandler {
     ...
     * Returns true if there are no attributes. The class attribute (if set) is
     * skipped when this test is performed.
     */
     ...
     *                                  deleted (probably because it is the class
     *                                  attribute).
     */
     ...
     * 
     * @throws IllegalArgumentException if string attribute couldn't be successfully
     *                                  deleted (probably because it is the class
     *                                  attribute).
    ...
    /**
     * Creates a new dataset of the same size as this dataset using random sampling
     * with replacement.
     * 
     * @param random a random number generator
    ...
    /**
     * Creates a new dataset of the same size as this dataset using random sampling
     * with replacement according to the current instance weights. The weights of
     * the instances in the new dataset are set to one. See also
    ...
    /**
     * Creates a new dataset of the same size as this dataset using random sampling
     * with replacement according to the current instance weights. See also
     * resampleWithWeights(Random, double[], boolean[]).
     * 
     * @param random                a random number generator
     * @param representUsingWeights if true, copies are represented using weights in
     *                              resampled data
     * @return the new dataset
     */
     ...
     * replacement according to current instance weights. The size of the sample can
     * be specified as a percentage of this dataset. See also
     * resampleWithWeights(Random, double[], boolean[]).
     *
     * @param random                a random number generator
     * @param sampled               an array indicating what has been sampled, can
     *                              be null
     * @param representUsingWeights if true, copies are represented using weights in
     *                              resampled data
     * @param sampleSize            size of the new dataset as a percentage of the
     *                              size of this dataset
     * @return the new dataset
     * @throws IllegalArgumentException if the weights array is of the wrong length
     *                                  or contains negative weights.
     */
    ...
    /**
     * Creates a new dataset of the same size as this dataset using random sampling
     * with replacement according to the given weight vector. The weights of the
     * instances in the new dataset are set to one. The length of the weight vector
     * has to be the same as the number of instances in the dataset, and all weights
     * have to be positive. See also resampleWithWeights(Random, double[],
     * boolean[]).
     * 
     * @param random  a random number generator
     ...
     * instances in the new dataset are set to one. The length of the weight vector
     * has to be the same as the number of instances in the dataset, and all weights
     * have to be positive. Uses Walker's method, see pp. 232 of "Stochastic
     * Simulation" by B.D. Ripley (1987).
     * 
     * @param random  a random number generator
     * @param weights the weight vector
    ...
    /**
     * Creates a new dataset of the same size as this dataset using random sampling
     * with replacement according to the given weight vector. The length of the
     * weight vector has to be the same as the number of instances in the dataset,
     * and all weights have to be positive. Uses Walker's method, see pp. 232 of
     ...
     * vector has to be the same as the number of instances in the dataset, and all
     * weights have to be positive. Uses Walker's method, see pp. 232 of "Stochastic
     * Simulation" by B.D. Ripley (1987). The size of the sample can be specified as
     * a percentage of this dataset.
     * 
     * @param random                a random number generator
     * @param weights               the weight vector
     * @param sampled               an array indicating what has been sampled, can
     ...
     * 
     * @param numFolds the number of folds in the cross-validation. Must be greater
     *                 than 1.
     ...
     * <ul>
     * <li><code>weka.core.Instances</code> help<br/>
     * prints a short list of possible commands.</li>
     * <li><code>weka.core.Instances</code> &lt;filename&gt;<br/>
     ...
     * <li><code>weka.core.Instances</code> headers &lt;filename1&gt;
     * &lt;filename2&gt;<br/>
     * Compares the headers of the two datasets and prints whether they match or
     * not.</li>
     * <li><code>weka.core.Instances</code> randomize &lt;seed&gt;
     * &lt;filename&gt;<br/>
