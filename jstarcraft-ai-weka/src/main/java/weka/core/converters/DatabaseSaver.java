...
public class DatabaseSaver extends AbstractSaver implements BatchConverter, IncrementalConverter, DatabaseConverter, OptionHandler, EnvironmentHandler {
    ...
    /**
     * Flag indicating whether the default name of the table is the relaion name or
     * not.
     */
    ...
    public static void main(String[] options) {
        ...
        try {
            ...
            /*
             * asv.setRetrieval(INCREMENTAL); Instances instances = asv.getInstances();
             * asv.setStructure(instances); for(int i = 0; i < instances.numInstances();
             * i++){ //last instance is null and finishes incremental saving
             * asv.writeIncremental(instances.instance(i)); } asv.writeIncremental(null);
             */
    ...
    public void resetOptions() {
         ...
         * m_createDate =
         * m_DataBaseConnection.getProperties().getProperty("CREATE_DATE", "DATETIME");
         * m_DateFormat = new SimpleDateFormat(m_DataBaseConnection.getProperties
