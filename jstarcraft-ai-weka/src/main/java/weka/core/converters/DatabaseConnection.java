...
public class DatabaseConnection extends DatabaseUtils {
    ...
    /**
     * Check if the property checkUpperCaseNames in the DatabaseUtils file is set to
     * true or false.
     *
     * @return true if the property checkUpperCaseNames in the DatabaseUtils file is
