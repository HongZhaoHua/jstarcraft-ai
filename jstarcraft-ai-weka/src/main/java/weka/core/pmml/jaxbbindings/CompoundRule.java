...
@XmlType(name = "", propOrder = { "extension", "simplePredicate", "compoundPredicate", "simpleSetPredicate", "_true", "_false", "rule" })
...
public class CompoundRule {
    ...
    @XmlElements({ @XmlElement(name = "CompoundRule", namespace = "http://www.dmg.org/PMML-4_1", required = true, type = CompoundRule.class), @XmlElement(name = "SimpleRule", namespace = "http://www.dmg.org/PMML-4_1", required = true, type = SimpleRule.class) })
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link CompoundRule
     * } {@link SimpleRule }
     * 
     * 
     */
