...
public enum VALIDTIMESPEC {
    ...
    EXCLUDE_FROM_TO("excludeFromTo"), @XmlEnumValue("excludeSet")
    EXCLUDE_SET("excludeSet"), @XmlEnumValue("includeAll")
    INCLUDE_ALL("includeAll"), @XmlEnumValue("includeFromTo")
    INCLUDE_FROM_TO("includeFromTo"), @XmlEnumValue("includeSet")
