...
public class MiningModel {
    ...
    @XmlElementRefs({ @XmlElementRef(name = "Regression", namespace = "http://www.dmg.org/PMML-4_1", type = Regression.class), @XmlElementRef(name = "ModelExplanation", namespace = "http://www.dmg.org/PMML-4_1", type = ModelExplanation.class), @XmlElementRef(name = "ModelStats", namespace = "http://www.dmg.org/PMML-4_1", type = ModelStats.class), @XmlElementRef(name = "Output", namespace = "http://www.dmg.org/PMML-4_1", type = Output.class), @XmlElementRef(name = "LocalTransformations", namespace = "http://www.dmg.org/PMML-4_1", type = LocalTransformations.class), @XmlElementRef(name = "DecisionTree", namespace = "http://www.dmg.org/PMML-4_1", type = DecisionTree.class), @XmlElementRef(name = "Segmentation", namespace = "http://www.dmg.org/PMML-4_1", type = Segmentation.class), @XmlElementRef(name = "Targets", namespace = "http://www.dmg.org/PMML-4_1", type = Targets.class), @XmlElementRef(name = "MiningSchema", namespace = "http://www.dmg.org/PMML-4_1", type = MiningSchema.class),
     ...
     * line 1801 of file:/home/david/workspace/weka/pmml-4-1.xsd line 1788 of
     ...
     * {@link ModelExplanation } {@link Regression } {@link ModelStats }
     * {@link Output } {@link LocalTransformations } {@link DecisionTree }
     * {@link Segmentation } {@link Targets } {@link MiningSchema }
