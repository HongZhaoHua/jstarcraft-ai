...
public class ContingencyTables {
     ...
     * Rows and columns with all zeros are not considered relevant.
     *
    ...
    /**
     * Computes conditional entropy of the columns given the rows of the test matrix
     * with respect to the train matrix. Uses a Laplace prior. Does NOT normalize
     * the entropy.
     *
    ...
    /**
     * Returns negative base 2 logarithm of multiple hypergeometric probability for
     * a contingency table.
     *
     * @param matrix the contingency table
     ...
     * @return the chi-value for that cell; 0 if the expected value is too close to
     *         zero
     */
