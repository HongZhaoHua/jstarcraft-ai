...
public abstract class PackageManager {
     ...
     * proxy defined by the properties http.proxyHost and http.proxyPort, and if the
     * user has set values for the properties (note, these are not standard java
    ...
    /**
     * Apply the supplied settings. Default implementation does nothing. Subclasses
     * should override to take note of settings changes.
     * 
