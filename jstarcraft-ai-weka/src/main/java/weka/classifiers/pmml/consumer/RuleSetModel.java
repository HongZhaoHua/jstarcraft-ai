...
public class RuleSetModel extends PMMLClassifier {
    ...
    static abstract class Rule implements Serializable {
         ...
         * 
         * @param input          a vector of independent and derived independent
         *                       variables
    ...
    static class SimpleRule extends Rule {
        ...
        /**
         * The predicted value as a number (regression) or index (classification) when
         * the rule fires (required)
         */
        ...
        protected ArrayList<TreeModel.ScoreDistribution> m_scoreDistributions = new ArrayList<TreeModel.ScoreDistribution>();
         ...
         * 
         * @param instance a vector containing the incoming independent and derived
         *                 independent variables
         * @param classAtt the class attribute
         * @param rsm      the rule selection method (ignored by simple rules)
         * @return a probability distribution over the class labels or the predicted
         *         value (in element zero of the array if the class is numeric)
         * @throws Exception if something goes wrong
         */
        ...
        /**
         * Get the predicted value of this rule (either a number for regression problems
         * or an index of a class label for classification problems)
         * 
    ...
    static class RuleSet implements Serializable {
        ...
        enum RuleSelectionMethod {
            WEIGHTEDSUM("weightedSum"), WEIGHTEDMAX("weightedMax"), FIRSTHIT("firstHit");
        ...
        /**
         * The number of training/test cases to which the ruleset was applied to
         * generate support and confidence measures for individual rules (optional)
         */
        private double m_recordCount = Utils.missingValue();

        /**
         * The number of training/test cases for which the default score is correct
         * (optional)
         */
        private double m_nbCorrect = Utils.missingValue();

        /**
         * The default value to predict when no rule in the ruleset fires (as a String;
         * optional)
         */
        private String m_defaultScore;

        /**
         * The default value to predict (either a real value or an index)
         */
        private double m_defaultPrediction = Utils.missingValue();

        /**
         * The default distribution to predict when no rule in the ruleset fires
         * (nominal class only, optional)
         */
        private ArrayList<TreeModel.ScoreDistribution> m_scoreDistributions = new ArrayList<TreeModel.ScoreDistribution>();

        /**
         * The default confidence value to return along with a score when no rules in
         * the set fire (optional)
         */
        ...
        private ArrayList<RuleSelectionMethod> m_availableRuleSelectionMethods = new ArrayList<RuleSelectionMethod>();
