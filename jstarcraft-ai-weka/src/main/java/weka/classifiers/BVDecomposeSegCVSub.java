 ...
 * any classifier using the sub-sampled cross-validation procedure as specified
 * in (1).<br/>
 ...
 * <br/>
 * Geoffrey I. Webb, Paul Conilione (2002). Estimating bias and variance from
 * data. School of Computer Science and Software Engineering, Victoria,
 * Australia.<br/>
 * <br/>
 * Ron Kohavi, David H. Wolpert: Bias Plus Variance Decomposition for Zero-One
 * Loss Functions. In: Machine Learning: Proceedings of the Thirteenth
 * International Conference, 275-283, 1996.<br/>
 * <br/>
 * Geoffrey I. Webb (2000). MultiBoosting: A Technique for Combining Boosting
 * and Wagging. Machine Learning. 40(2):159-196.
 * <p/>
 * <!-- globalinfo-end -->
 *
...
public class BVDecomposeSegCVSub implements OptionHandler, TechnicalInformationHandler, RevisionHandler {
    ...
    public void setOptions(String[] options) throws Exception {
        ...
        // throw new Exception("A training set size must be specified" + " with a -T
        // option.");
    ...
    /**
     * Get the calculated bias squared according to the Kohavi and Wolpert
     * definition
     *
     ...
     *
     * @param proportion the proportion of instances that are common between
     *                   training sets.
     *
     */
    ...
    /**
     * Carry out the bias-variance decomposition using the sub-sampled
    ...
    public void decompose() throws Exception {
        ...
        // number of folds cannot be more than the number of instances in the training
        // pool
        if (k > tps) {
        ...
        // create confusion matrix, columns = number of instances in data set, as all
        // will be used, by rows = number of classes.
     ...
     * selected for a given instance.
     * <p>
     *
     * For example, instance 'x' may be classified out of 3 classes y = {1, 2, 3},
     * so if x is classified 10 times, and is classified as follows, '1' = 2 times,
     * '2' = 5 times and '3' = 3 times. Then the central tendency is '2'.
     * <p>
     *
     * However, it is important to note that this method returns a list of all
     * classes that have the highest number of classifications.
     *
     * In cases where there are several classes with the largest number of
     * classifications, then all of these classes are returned. For example if 'x'
     * is classified '1' = 4 times, '2' = 4 times and '3' = 2 times. Then '1' and
     * '2' are returned.
     * <p>
     *
    ...
    public Vector<Integer> findCentralTendencies(double[] predProbs) {
        ...
        int centralTValue = 0;
        int currentValue = 0;
        // array to store the list of classes the have the greatest number of
        // classifictions.
