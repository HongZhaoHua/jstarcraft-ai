...
public class SearchAlgorithm implements OptionHandler, Serializable, RevisionHandler {
    ...
    /**
     * File name containing initial network structure. This can be used as starting
     * point for structure search It will be ignored if not speficied. When
     * specified, it overrides the InitAsNaivBayes flag.
     */
