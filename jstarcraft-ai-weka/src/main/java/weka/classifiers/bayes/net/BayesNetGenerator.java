...
public class BayesNetGenerator extends EditableBayesNet {
    ...
    /**
     * Generate random connected Bayesian network with discrete nodes having all the
     * same cardinality.
     * 
     ...
     * keep on selecting one of the connected nodes and one of the unconnected ones
     * and add an arrow between them, till all nodes are connected.
     * 
     * @param nNodes number of nodes in the Bayes net to generate
     */
