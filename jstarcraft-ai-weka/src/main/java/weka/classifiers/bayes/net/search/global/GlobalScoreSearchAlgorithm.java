...
public class GlobalScoreSearchAlgorithm extends SearchAlgorithm {
    ...
    /**
     * performCV returns the accuracy calculated using cross validation. The dataset
     * used is m_Instances associated with the Bayes Network.
     * 
     ...
     * validation. The idea is to run through the data set and try to classify each
     * of the instances based on the previously seen data. The data set used is
     * m_Instances associated with the Bayes Network.
     * 
     * @param bayesNet : Bayes Network containing structure to evaluate
     * @return accuracy (in interval 0..1) measured using leave one out cv.
     * @throws Exception passed on by updateClassifier
