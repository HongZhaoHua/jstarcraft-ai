 ...
 * structure search algorithms that are based on conditional independence test
 * (as opposed to for example score based of cross validation based search
 * algorithms).
 * <p/>
 * <!-- globalinfo-end -->
 *
...
public class CISearchAlgorithm extends LocalScoreSearchAlgorithm {
     ...
     * @param iAttributesZ - array of integers representing indices of attributes in
     *                     set Z
