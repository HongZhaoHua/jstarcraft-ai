 ...
 * or the classifier are unable to deal with them, the instances and/or
 * attributes are resampled with replacement based on the weights before they
 * are passed to the filter or the classifier (as appropriate).
 * <p/>
 * <!-- globalinfo-end -->
 *
 ...
 * If this is set, the classifier will not check whether the filter modifies the
 * class attribute (use with caution).
 * <p>
 *
...
public class FilteredClassifier extends RandomizableSingleClassifierEnhancer implements Drawable, PartitionGenerator, IterativeClassifier, BatchPredictor, WeightedInstancesHandler, WeightedAttributesHandler {
    ...
    /**
     * Flag that can be set to true if class attribute is not to be checked for
     * modifications by the filer.
     */
    ...
    /**
     * Computes an array that has a value for each element in the partition. (If the
     * base classifier supports this.)
     */
    ...
    /**
     * Returns true if classifier checks whether class attribute has been modified
     * by filter.
     */
    ...
    /**
     * Use this method to determine whether classifier checks whether class
     * attribute has been modified by filter.
     */
    ...
    protected Instance filterInstance(Instance instance) throws Exception {
        ...
        /*
         * System.err.println("FilteredClassifier:: " + m_Filter.getClass().getName() +
         * " in: " + instance);
         */
    ...
    /**
     * Batch scoring method. Calls the appropriate method for the base learner if it
     * implements BatchPredictor. Otherwise it simply calls the
    ...
    /**
     * Returns true if the base classifier implements BatchPredictor and is able to
     * generate batch predictions efficiently
     * 
