...
/**
 * <!-- globalinfo-start --> This method constructs a decision tree based
 * classifier that maintains highest accuracy on training data and improves on
 * generalization accuracy as it grows in complexity. The classifier consists of
 * multiple trees constructed systematically by pseudorandomly selecting subsets
 * of components of the feature vector, that is, trees constructed in randomly
 * chosen subspaces.<br/>
 * <br/>
...
public class RandomSubSpace extends RandomizableParallelIteratedSingleClassifierEnhancer implements WeightedInstancesHandler, TechnicalInformationHandler {
     ...
     * @param fraction the fraction - if less than 1 it represents the percentage,
     *                 otherwise the absolute number of attributes
    ...
    /**
     * generates an index string describing a random subspace, suitable for the
     * Remove filter.
     * 
