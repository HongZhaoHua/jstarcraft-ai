 ...
 * correcting output codes for increased accuracy.
 * <p/>
 * <!-- globalinfo-end -->
 *
...
public class MultiClassClassifier extends RandomizableSingleClassifierEnhancer implements OptionHandler {
    ...
    /**
     * The multiplier when generating random codes. Will generate numClasses *
     * m_RandomWidthFactor codes
     */
    ...
    public static final Tag[] TAGS_METHOD = { new Tag(METHOD_1_AGAINST_ALL, "1-against-all"), new Tag(METHOD_ERROR_RANDOM, "Random correction code"), new Tag(METHOD_ERROR_EXHAUSTIVE, "Exhaustive correction code"), new Tag(METHOD_1_AGAINST_1, "1-against-1") };
    ...
    private abstract class Code implements Serializable, RevisionHandler {
        ...
        /**
         * Subclasses must allocate and fill these. First dimension is number of codes.
        ...
        /**
         * Returns the indices of the values set to true for this code, using 1-based
         * indexing (for input to Range).
         * 
    ...
    /*
     * TODO: Constructs codes as per: Bose, R.C., Ray Chaudhuri (1960), On a class
     * of error-correcting binary group codes, Information and Control, 3, 68-79.
     ...
     * Used by StackedMultiClassClassifier. Returns the probability for the second
     * "class" predicted by each base classifier.
     *
    ...
    /**
     * Gets the multiplier when generating random codes. Will generate numClasses *
     * m_RandomWidthFactor codes.
     *
    ...
    /**
     * Sets the multiplier when generating random codes. Will generate numClasses *
     * m_RandomWidthFactor codes.
     *
    ...
    /**
     * Set whether to use pairwise coupling with 1-vs-1 classification to improve
    ...
    /**
     * Gets whether to use pairwise coupling with 1-vs-1 classification to improve
     * probability estimates.
     *
