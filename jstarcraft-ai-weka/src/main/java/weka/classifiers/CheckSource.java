 ...
 * implementing the <code>weka.classifiers.Sourcable</code> interface. It takes
 * a classifier, the classname of the generated source and the dataset the
 * source was generated with as parameters and tests the output of the built
 * classifier against the output of the generated source. Use option '-h' to
