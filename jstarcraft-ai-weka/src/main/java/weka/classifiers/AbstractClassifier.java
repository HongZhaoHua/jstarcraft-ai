...
public abstract class AbstractClassifier implements Classifier, BatchPredictor, Cloneable, Serializable, OptionHandler, CapabilitiesHandler, RevisionHandler, CapabilitiesIgnorer, CommandlineRunnable {
     ...
     * OptionHandler and the options parameter is non-null, the classifier will have
     * it's options set.
     *
    ...
    /**
     * Return true if this classifier can generate batch predictions in an efficient
     * manner. Default implementation here returns false. Subclasses to override as
     * appropriate.
     * 
