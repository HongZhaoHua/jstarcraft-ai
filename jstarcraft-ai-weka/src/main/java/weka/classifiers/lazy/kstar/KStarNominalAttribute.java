...
public class KStarNominalAttribute implements KStarConstants, RevisionHandler {
    ...
    /**
     * Probability of test attribute transforming into train attribute with missing
     * value
     */
    ...
    /**
     * Calculates the "stop parameter" for this attribute using the entropy method:
     * the value is computed using a root finder algorithm. The method takes
     * advantage of the calculation to compute the smallest and average
    ...
    /**
     * Calculates the distribution, in the dataset, of the indexed nominal attribute
     * values. It also counts the actual number of training instances that
     * contributed (those with non-missing values) to calculate the distribution.
     */
