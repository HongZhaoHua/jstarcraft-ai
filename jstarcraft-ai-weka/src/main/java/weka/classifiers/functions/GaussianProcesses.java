 ...
 * target attribute as well as the other attributes (if
 * normalization/standardizaton is turned on). Missing values are replaced by
 * the global mean/mode. Nominal attributes are converted to binary ones. Note
 * that kernel caching is turned off if the kernel used implements CachedKernel.
 * * <br>
 * <br>
 * <!-- globalinfo-end -->
 * 
...
public class GaussianProcesses extends RandomizableClassifier implements IntervalEstimator, ConditionalDensityEstimator, TechnicalInformationHandler, WeightedInstancesHandler {
     ...
     * purely numeric, doesn't contain any missing values, and has a numeric class.
     */
