...
public class LinearRegression extends AbstractClassifier implements OptionHandler, WeightedInstancesHandler {
    ...
    /**
     * Whether to output additional statistics such as std. dev. of coefficients and
     * t-stats
     */
     ...
     *
     * @param data the training data to be used for generating the linear regression
     *             function
    ...
    /**
     * Sets whether to be more memory conservative or being able to output the model
     * as string.
     *
    ...
    /**
     * Removes the attribute with the highest standardised coefficient greater than
     * 1.5 from the selected attributes.
     *
     ...
     *
     * @param selectedAttributes an array of booleans where each element is true if
     *                           the corresponding attribute should be included in
     *                           the regression.
