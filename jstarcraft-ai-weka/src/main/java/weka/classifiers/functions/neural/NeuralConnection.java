...
public abstract class NeuralConnection implements Serializable, RevisionHandler {
    ...
    /**
     * The string that uniquely (provided naming is done properly) identifies this
     * unit.
     */
    ...
    /**
     * Call this to reset the unit for another run. It is expected by that this unit
     * will call the reset functions of all input units to it. It is also expected
     * that this will not be done if the unit has already been reset (or atleast
     * appears to be).
     */
     ...
     * weights have been updated at this unit, All the input connections will then
     * be called from this to have their weights updated.
     * 
    ...
    /**
     * Use this to get easy access to the inputs. It is not advised to change the
     * entries in this list (use the connecting and disconnecting functions to do
     * that)
     * 
    ...
    /**
     * Use this to get easy access to the outputs. It is not advised to change the
     * entries in this list (use the connecting and disconnecting functions to do
     * that)
     * 
    ...
    /**
     * Use this to get easy access to the input numbers. It is not advised to change
     * the entries in this list (use the connecting and disconnecting functions to
     * do that)
     * 
    ...
    /**
     * This will allocate more space for input connection information if the arrays
     * for this have been filled up.
     */
    ...
    /**
     * Allocates more space for output connection information if the arrays have
     * been filled up.
     */
    ...
    /**
     * This will disconnect the input with the specific connection number From this
     * node (only on this end however).
     * 
     * @param i The unit to disconnect.
     * @param n The connection number at the other end, -1 if all the connections to
     *          this unit should be severed.
     * @return True if the connection was removed, false if the connection was not
     *         found.
     */
    ...
    /**
     * This function will remove all the inputs to this unit. In doing so it will
    ...
    /**
     * This will disconnect the output with the specific connection number From this
     * node (only on this end however).
     * 
    ...
    /**
     * This function will remove all outputs to this unit. In doing so it will also
     * terminate the connections at the other end.
     */
     ...
     * @param s The source unit.
     * @param t The target unit.
     * @return True if the units were disconnected, false if they weren't (probably
     *         due to there being no connection).
     */
