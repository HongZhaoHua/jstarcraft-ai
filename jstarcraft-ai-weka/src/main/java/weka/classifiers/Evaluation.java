...
public class Evaluation implements Serializable, Summarizable, RevisionHandler {
    ...
    /**
     * Returns the SF per instance, which is the null model entropy minus the scheme
    ...
    /**
     * Calculate number of false positives with respect to a particular class. This
     * is defined as
     * <p/>
     * 
     * <pre>
    ...
    /**
     * Calculate number of false negatives with respect to a particular class. This
     * is defined as
     * <p/>
     * 
     * <pre>
