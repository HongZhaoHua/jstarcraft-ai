...
public interface InformationTheoreticEvaluationMetric {
     ...
     * implement this method if it is not possible to compute their statistics from
     * what is stored in the base Evaluation object.
     * 
     ...
     * ConditionalDensityEstimators. Implementers need only implement this method if
     * it is not possible to compute their statistics from what is stored in the
