...
public class RegressionAnalysis {
    ...
    /**
     * Returns the sum of squared residuals of the simple linear regression model: y
     * = a + bx.
     * 
     ...
     * squared residuals is already calculated. This works for either a simple or a
    ...
    public static double[] calculateStdErrorOfCoef(Instances data, Attribute chosen, double slope, double intercept, int df) throws Exception {
        ...
        /*
         * linear algebra calculation: covariance matrix = mse * (XtX)^-1 diagonal of
         * covariance matrix is square of standard error of coefficients
         */
     ...
     * linear regression. The last element in the array is the standard error of the
     * constant coefficient. The standard error array is used to calculate the
     * t-statistics.
     * 
     * @param data     (the data set
    ...
    /**
     * Returns an array of the t-statistic of each coefficient in a multiple linear
     * regression model.
     * 
