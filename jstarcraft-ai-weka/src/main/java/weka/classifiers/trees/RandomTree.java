...
public class RandomTree extends AbstractClassifier implements OptionHandler, WeightedInstancesHandler, Randomizable, Drawable, PartitionGenerator {
    ...
    /**
     * Indexed by attribute, each two element array contains impurity decrease/gain
     * sum in first element and count in the second
     */
    ...
    /**
     * Set whether to compute/store impurity decreases for variable importance in
     * RandomForest
     *
    ...
    /**
     * Get whether to compute/store impurity decreases for variable importance in
     * RandomForest
     *
     ...
     * 
     * @param newAllowUnclassifiedInstances true if tree is allowed to abstain from
     *                                      making a prediction
     */
