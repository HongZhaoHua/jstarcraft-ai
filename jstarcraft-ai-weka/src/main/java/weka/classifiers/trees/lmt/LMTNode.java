...
public class LMTNode extends LogisticBase {
    ...
    /**
     * Weighted number of training examples currently misclassified by the logistic
     * model at the node
     */
     ...
     *                            LogitBoost at higher levels in the tree. They
     *                            represent a logistic regression model that is
     *                            refined locally at this node.
     ...
     * parameter. Generates a sequence of alpha-values with error estimates for the
     * corresponding (partially pruned) trees, given the test set of that fold.
     * 
     ...
     * Faster than re-growing the tree because the logistic models do not have to be
     * fit again.
     */
    ...
    /**
     * Determines the optimum number of LogitBoost iterations to perform by building
     * a standalone logistic regression function on the training data. Used for the
     * heuristic that avoids cross-validating this number again at every node.
     * 
     ...
     * replaced by binary ones, and the class variable is replaced by a pseudo-class
     * variable that is used by LogitBoost.
     */
    @Override
    ...
    /**
     * Returns a description of the logistic model tree (tree structure and logistic
     * models)
     * 
    ...
    /**
     * Returns a string describing the number of LogitBoost iterations performed at
     * this node, the total number of LogitBoost iterations performed (including
     * iterations at higher levels in the tree), and the number of training examples
     * at this node.
     * 
