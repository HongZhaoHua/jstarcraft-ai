...
public class AggregateableEvaluation extends Evaluation {
    ...
    public AggregateableEvaluation(Evaluation eval) throws Exception {
        ...
        m_delegate = new weka.classifiers.evaluation.AggregateableEvaluation(eval.m_delegate);
    }

    /**
     * Adds the statistics encapsulated in the supplied Evaluation object into this
     * one. Does not perform any checks for compatibility between the supplied
