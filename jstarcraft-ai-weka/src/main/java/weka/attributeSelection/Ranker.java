...
public class Ranker extends ASSearch implements RankedOutputSearch, StartSetHandler, OptionHandler {
    ...
    /**
     * Specify the number of attributes to select from the ranked list. -1 indicates
     * that all attributes are to be retained.
     * 
    ...
    /**
     * This is a dummy method. Ranker can ONLY be used with attribute evaluators and
     * as such can only produce a ranked list of attributes
     * 
     ...
     * each attribute not included in the startSet and then sorts them to produce a
