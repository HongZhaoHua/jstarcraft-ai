 ...
 * <br/>
 * Evaluates the worth of an attribute by using a user-specified
 * classifier.<br/>
 * <p/>
 * <!-- globalinfo-end -->
 * 
...
public class ClassifierAttributeEval extends ASEvaluation implements AttributeEvaluator, OptionHandler {
     ...
     * isolation
     * 
     * @return true if each attribute should be evaluated by measuring the impact of
     *         leaving it out from the full set
     */
