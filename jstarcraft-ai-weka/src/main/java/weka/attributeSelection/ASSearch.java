 ...
 * @version $Revision$
 */
public abstract class ASSearch implements Serializable, RevisionHandler {
    ...
    /**
     * Creates a new instance of a search class given it's class name and (optional)
     * arguments to pass to it's setOptions method. If the search method implements
     * OptionHandler and the options parameter is non-null, the search method will
    ...
    /**
     * Creates copies of the current search scheme. Note that this method now uses
     * Serialization to perform a deep copy, so the search object must be fully
