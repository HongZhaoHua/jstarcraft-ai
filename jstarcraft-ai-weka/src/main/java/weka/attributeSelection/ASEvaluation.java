...
public abstract class ASEvaluation implements Serializable, CapabilitiesHandler, CapabilitiesIgnorer, RevisionHandler, CommandlineRunnable {
    ...
    /**
     * Provides a chance for a attribute evaluator to do any special post processing
     * of the selected attribute set. Can also be used to clean up any data
     * structures post attribute selection.
     * 
    ...
    /**
     * Creates a new instance of an attribute/subset evaluator given it's class name
     * and (optional) arguments to pass to it's setOptions method. If the evaluator
     * implements OptionHandler and the options parameter is non-null, the evaluator
     * will have it's options set.
     * 
    ...
    /**
     * Tells the evaluator that the attribute selection process is complete. It can
     * then clean up data structures, references to training data as necessary in
