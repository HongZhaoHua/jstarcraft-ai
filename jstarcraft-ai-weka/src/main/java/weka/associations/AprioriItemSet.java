...
public class AprioriItemSet extends ItemSet implements Serializable, RevisionHandler {
     ...
     * @param premise          the premise of the rule
     * @param consequence      the consequence of the rule
     * @param consequenceCount how many times the consequence occurs independent of
     *                         the premise
     ...
     * @param hashtables        containing all(!) previously generated item sets
     * @param numItemsInSet     the size of the item set for which the rules are to
     *                          be generated
     ...
     * @return an item set that only contains items form this item sets that are not
     *         contained by toSubtract
     */
     ...
     * 
     * @param rules                 all the rules having (k-1)-item sets as
     *                              consequences
     * @param numItemsInSet         the size of the item set for which the rules are
     *                              to be generated
     * @param numItemsInConsequence the value of (k-1)
     * @param minConfidence         the minimum confidence a rule has to have
     * @param hashtables            the hashtables containing all(!) previously
     *                              generated item sets
