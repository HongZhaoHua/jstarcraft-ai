 ...
 * class <code>CheckAttributeSelection</code> to determine success or failure of
 * the tests. It follows basically the <code>testsPerClassType</code> method.
 *
...
public abstract class AbstractAttributeSelectionTest extends TestCase {
    ...
    /**
     * wether scheme can predict nominal attributes (array index is attribute type
     * of class)
     */
    protected boolean[] m_NominalPredictors;

    /**
     * wether scheme can predict numeric attributes (array index is attribute type
     * of class)
     */
    protected boolean[] m_NumericPredictors;

    /**
     * wether scheme can predict string attributes (array index is attribute type of
     * class)
     */
    protected boolean[] m_StringPredictors;

    /**
     * wether scheme can predict date attributes (array index is attribute type of
     * class)
     */
    protected boolean[] m_DatePredictors;

    /**
     * wether scheme can predict relational attributes (array index is attribute
     * type of class)
     */
    ...
    /**
     * Constructs the <code>AbstractAttributeSelectionTest</code>. Called by
     * subclasses.
     *
     ...
     * default scheme to test and loads a test set of Instances.
     *
    ...
    /**
     * tests whether the scheme can handle certain attributes and if not, if the
     * exception is OK
     *
     ...
     * @see CheckAttributeSelection#canPredict(boolean, boolean, boolean, boolean,
     *      boolean, boolean, int)
     * @see CheckAttributeSelection#testsPerClassType(int, boolean, boolean)
     */
    ...
    /**
     * tests whether the scheme can handle different types of attributes and if not,
     ...
     *
     * @see CheckAttributeSelection#instanceWeights(boolean, boolean, boolean,
     ...
     *
     * @see CheckAttributeSelection#canHandleNClasses(boolean, boolean, boolean,
     *      boolean, boolean, boolean, int)
     * @see CheckAttributeSelection#testsPerClassType(int, boolean, boolean)
     * @see #m_NClasses
     */
    ...
    /**
     * checks whether the scheme can handle the class attribute at a given position
    ...
    /**
     * Tests whether the scheme can handle class attributes as Nth attribute. In
     * case of multi-instance handler it performs no tests, since the multi-instance
     * data has a fixed format (bagID,bag,class).
     *
     * @see CheckAttributeSelection#canHandleClassAsNthAttribute(boolean, boolean,
     ...
     *
     * @see CheckAttributeSelection#canHandleZeroTraining(boolean, boolean, boolean,
     *      boolean, boolean, boolean, int)
     * @see CheckAttributeSelection#testsPerClassType(int, boolean, boolean)
     */
    ...
    /**
     * checks whether the scheme can handle the given percentage of missing
     * predictors
     *
     * @param type      the class type
     ...
     *
     * @see CheckAttributeSelection#canHandleMissing(boolean, boolean, boolean,
     *      boolean, boolean, boolean, int, boolean, boolean, int)
     * @see CheckAttributeSelection#testsPerClassType(int, boolean, boolean)
     */
    ...
    /**
     * checks whether the scheme can handle the given percentage of missing class
     * labels
     *
     * @param type      the class type
    ...
    /**
     * tests whether the scheme can handle missing class values (20% and 100%)
     *
     * @see CheckAttributeSelection#canHandleMissing(boolean, boolean, boolean,
     *      boolean, boolean, boolean, int, boolean, boolean, int)
     * @see CheckAttributeSelection#testsPerClassType(int, boolean, boolean)
     ...
     *
     * @see CheckAttributeSelection#correctSearchInitialisation(boolean, boolean,
    ...
    public void testBuildInitialization() {
        ...
        for (i = FIRST_CLASSTYPE; i <= LAST_CLASSTYPE; i++) {
            ...
            result = m_Tester.correctSearchInitialisation(m_NominalPredictors[i], m_NumericPredictors[i], m_StringPredictors[i], m_DatePredictors[i], m_RelationalPredictors[i], m_multiInstanceHandler, i);
     ...
     *
     * @see CheckAttributeSelection#datasetIntegrity(boolean, boolean, boolean,
