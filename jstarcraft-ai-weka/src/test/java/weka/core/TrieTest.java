...
/**
 * Tests Trie. Run from the command line with:
 * <p/>
...
public class TrieTest extends TestCase {
    ...
    /**
     * tests whether all the string the Trie got built with can be retrieved again
     * (tests building and retrieval via iterator).
     */
    ...
    /**
     * tests whether a different order of strings presented to the Trie will result
     * in a different Trie (= error).
     */
