...
public abstract class AbstractNearestNeighbourSearchTest extends TestCase {
    ...
    /**
     * Configures the CheckOptionHandler uses for testing the option handling. Sets
     * the NearestNeighbourSearch returned from the getNearestNeighbourSearch()
     * method
     * 
     ...
     * NearestNeighbourSearch returned from the getNearestNeighbourSearch() method.
     * 
    ...
    /**
     * Runs the NearestNeighbourSearch with the given data and returns the generated
     * results.
     * 
