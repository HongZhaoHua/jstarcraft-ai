 ...
 * <code>CheckClusterer</code> to determine success or failure of the tests. It
 * follows basically the <code>runTests</code> method.
 *
...
public abstract class AbstractClustererTest extends TestCase {
    ...
    /**
     * wether clusterer can predict nominal attributes (array index is attribute
     * type of class)
     */
    protected boolean m_NominalPredictors;

    /**
     * wether clusterer can predict numeric attributes (array index is attribute
     * type of class)
     */
    protected boolean m_NumericPredictors;

    /**
     * wether clusterer can predict string attributes (array index is attribute type
     * of class)
     */
    protected boolean m_StringPredictors;

    /**
     * wether clusterer can predict date attributes (array index is attribute type
     * of class)
     */
    protected boolean m_DatePredictors;

    /**
     * wether clusterer can predict relational attributes (array index is attribute
     * type of class)
     */
     ...
     * default clusterer to test and loads a test set of Instances.
     *
    ...
    /**
     * Configures the CheckGOE used for testing GOE stuff. Sets the Clusterer
     * returned from the getClusterer() method.
     * 
    ...
    /**
     * tests whether the clusterer can handle certain attributes and if not, if the
     * exception is OK
     *
     ...
     * @see CheckClusterer#canPredict(boolean, boolean, boolean, boolean, boolean,
     *      boolean)
     * @see CheckClusterer#runTests(boolean, boolean, boolean)
     */
    ...
    /**
     * tests whether the clusterer can handle different types of attributes and if
     ...
     *
     * @see CheckClusterer#instanceWeights(boolean, boolean, boolean, boolean,
     *      boolean, boolean)
     * @see CheckClusterer#runTests(boolean, boolean, boolean)
     */
     ...
     *
     * @see CheckClusterer#canHandleZeroTraining(boolean, boolean, boolean, boolean,
     *      boolean, boolean)
     * @see CheckClusterer#runTests(boolean, boolean, boolean)
     */
    ...
    /**
     * checks whether the clusterer can handle the given percentage of missing
     * predictors
     *
     ...
     *
     * @see CheckClusterer#canHandleMissing(boolean, boolean, boolean, boolean,
    ...
    /**
     * tests whether the clusterer correctly initializes in the buildClusterer
     * method
     *
     * @see CheckClusterer#correctBuildInitialisation(boolean, boolean, boolean,
     ...
     *
     * @see CheckClusterer#datasetIntegrity(boolean, boolean, boolean, boolean,
     *      boolean, boolean, boolean)
     * @see CheckClusterer#runTests(boolean, boolean, boolean)
     */
     ...
     *
     * @see CheckClusterer#updatingEquality(boolean, boolean, boolean, boolean,
     *      boolean, boolean)
     * @see CheckClusterer#runTests(boolean, boolean, boolean)
     */
    ...
    /**
     * Builds a model using the current Clusterer using the given data and returns
     * the produced cluster assignments.
     * 
