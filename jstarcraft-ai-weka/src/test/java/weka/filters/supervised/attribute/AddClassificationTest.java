...
/**
 * Tests AddClassification. Run from the command line with:
 * <p/>
...
public class AddClassificationTest extends AbstractFilterTest {
    ...
    /**
     * performs the application with only classification set (Nominal class) and
     * removal of the old class attribute
     */
    ...
    /**
     * performs the application with only classification set (numeric class) and
     * removal of the old class attribute
     */
