...
public abstract class AbstractClassifierTest extends TestCase {
    ...
    /**
     * a class for postprocessing the test-data: all values of numeric attributs are
    ...
    /**
     * wether classifier can predict date attributes (array index is attribute type
     * of class)
     */
    protected boolean[] m_DatePredictors;

    /**
     * wether classifier can predict relational attributes (array index is attribute
     * type of class)
     */
    ...
    /**
     * tests whether the classifier can handle certain attributes and if not, if the
     * exception is OK
     * 
     ...
     * @see CheckClassifier#canPredict(boolean, boolean, boolean, boolean, boolean,
     *      boolean, int)
     * @see CheckClassifier#testsPerClassType(int, boolean, boolean, boolean)
     */
    ...
    /**
     * tests whether the classifier can handle different types of attributes and if
    ...
    /**
     * Tests whether the classifier can handle class attributes as Nth attribute. In
     * case of multi-instance classifiers it performs no tests, since the
     * multi-instance data has a fixed format (bagID,bag,class).
     * 
     * @see CheckClassifier#canHandleClassAsNthAttribute(boolean, boolean, boolean,
