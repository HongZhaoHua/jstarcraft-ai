 ...
 * <code>CheckAssociator</code> to determine success or failure of the tests. It
 ...
 * @see PostProcessor
 */
public abstract class AbstractAssociatorTest extends TestCase {
    ...
    /**
     * wether Associator can predict nominal attributes (array index is attribute
     * type of class)
     */
    protected boolean[] m_NominalPredictors;

    /**
     * wether Associator can predict numeric attributes (array index is attribute
     * type of class)
     */
    protected boolean[] m_NumericPredictors;

    /**
     * wether Associator can predict string attributes (array index is attribute
     * type of class)
     */
    protected boolean[] m_StringPredictors;

    /**
     * wether Associator can predict date attributes (array index is attribute type
     * of class)
     */
    protected boolean[] m_DatePredictors;

    /**
     * wether Associator can predict relational attributes (array index is attribute
     * type of class)
     */
    ...
    /**
     * Configures the CheckOptionHandler used for testing the optionhandling. Sets
     * the Associator returned from the getAssociator() method.
     * 
    ...
    /**
     * Configures the CheckGOE used for testing GOE stuff. Sets the Associator
     * returned from the getAssociator() method.
     * 
     ...
     * default Associator to test and loads a test set of Instances.
     *
    ...
    /**
     * tests whether the Associator can handle certain attributes and if not, if the
     * exception is OK
     *
     ...
     * @see CheckAssociator#canPredict(boolean, boolean, boolean, boolean, boolean,
     *      boolean, int)
     * @see CheckAssociator#testsPerClassType(int, boolean, boolean)
     */
    ...
    /**
     * tests whether the Associator can handle different types of attributes and if
     * not, if the exception is OK
     *
     ...
     *
     * @see CheckAssociator#instanceWeights(boolean, boolean, boolean, boolean,
     *      boolean, boolean, int)
     * @see CheckAssociator#testsPerClassType(int, boolean, boolean)
     */
     ...
     *
     * @see CheckAssociator#canHandleNClasses(boolean, boolean, boolean, boolean,
     *      boolean, boolean, int)
     * @see CheckAssociator#testsPerClassType(int, boolean, boolean)
     * @see #m_NClasses
     */
    ...
    /**
     * Tests whether the Associator can handle class attributes as Nth attribute. In
     * case of multi-instance Associators it performs no tests, since the
     * multi-instance data has a fixed format (bagID,bag,class).
     *
     * @see CheckAssociator#canHandleClassAsNthAttribute(boolean, boolean, boolean,
     ...
     *
     * @see CheckAssociator#canHandleZeroTraining(boolean, boolean, boolean,
    ...
    /**
     * checks whether the Associator can handle the given percentage of missing
     * predictors
     *
     * @param type      the class type
     ...
     *
     * @see CheckAssociator#canHandleMissing(boolean, boolean, boolean, boolean,
    ...
    /**
     * tests whether the Associator can handle missing class values (20% and 100%)
     *
     * @see CheckAssociator#canHandleMissing(boolean, boolean, boolean, boolean,
     *      boolean, boolean, int, boolean, boolean, int)
     * @see CheckAssociator#testsPerClassType(int, boolean, boolean)
    ...
    /**
     * tests whether the Associator correctly initializes in the buildAssociator
     * method
     *
     * @see CheckAssociator#correctBuildInitialisation(boolean, boolean, boolean,
     *      boolean, boolean, boolean, int)
     * @see CheckAssociator#testsPerClassType(int, boolean, boolean)
     */
    public void testBuildInitialization() {
        ...
        for (i = FIRST_CLASSTYPE; i <= LAST_CLASSTYPE + 1; i++) {
            ...
            result = m_Tester.correctBuildInitialisation(m_NominalPredictors[i], m_NumericPredictors[i], m_StringPredictors[i], m_DatePredictors[i], m_RelationalPredictors[i], m_multiInstanceHandler, type);
     ...
     *
     * @see CheckAssociator#datasetIntegrity(boolean, boolean, boolean, boolean,
    ...
    /**
     * Builds a model using the current Associator using the given data and returns
     * the produced output. TODO: unified rules as output instead of toString()
     * result???
     *
