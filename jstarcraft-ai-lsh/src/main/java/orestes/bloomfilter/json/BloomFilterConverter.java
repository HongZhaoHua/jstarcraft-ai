...
public class BloomFilterConverter {
    ...
    /**
     * Converts a normal or Counting Bloom filter to a JSON representation of a
     * non-counting Bloom filter.
     *
    ...
    /**
     * Converts a normal or Counting Bloom filter to a Base64 encoded string
     * containing its bits.
     *
     * @param source the Bloom filter to convert
