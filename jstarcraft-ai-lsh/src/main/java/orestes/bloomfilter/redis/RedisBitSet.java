...
/**
 * A persistent BitSet backed by Redis. Not all methods of the superclass are
 * implemented. If needed they can be used converting the RedisBitSet to a
 * regular BitSet by calling {@link #asBitSet()}. <br>
 * <br>
 * External transactions or pipeline can be propagated for use by modifying
 * methods (e.g. {@link #set(int)}).
 */
public class RedisBitSet extends BitSet {
    ...
    /**
     * Fetches the values at the given index positions in a multi transaction. This
    ...
    /**
     * Performs the normal {@link #set(int, boolean)} operation using the given
     * pipeline.
     *
