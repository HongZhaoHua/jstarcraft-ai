...
public class RedisUtils {
    ...
    public static Map<byte[], byte[]> encodeMap(Map<Integer, Long> map) {
        return map.entrySet().stream().collect(toMap(e -> encodeKey(e.getKey()), e -> encodeValue(e.getValue())));
    }
    ...
    public static Map<Integer, Long> decodeMap(Map<byte[], byte[]> map) {
        return map.entrySet().stream().collect(toMap(e -> decodeKey(e.getKey()), e -> decodeValue(e.getValue())));
    }
