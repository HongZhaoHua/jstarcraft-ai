...
public class MinHash implements Serializable {
    ...
    /**
     * Compute the exact jaccard index between two sets, represented as arrays of
     * booleans.
     * 
     * @param s1
     * @param s2
    ...
    /**
     * Initializes hash functions to compute MinHash signatures for sets built from
     * a dictionary of dict_size elements.
     *
    ...
    /**
     * Initializes hash function to compute MinHash signatures for sets built from a
     * dictionary of dict_size elements, with a given similarity estimation error.
     *
     * @param error
     * @param dict_size
     */
    ...
    /**
     * Computes the signature for this set The input set is represented as an vector
     * of booleans. For example the array [true, false, true, true, false]
