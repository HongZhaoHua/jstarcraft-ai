...
public class ExpiringBloomFilterPureRedisTest {
    ...
    public void setUp() throws Exception {
        ...
        builder.overwriteIfExists(true).gracePeriod(1, SECONDS);
    ...
    public void testUpdateConfig() throws Exception {
        ...
        builder.name(bloomFilter.config().name()).gracePeriod(1337).falsePositiveProbability(1337).size(1337).hashes(1337).expectedElements(1337).countingBits(1337).hashFunction(HashProvider.HashMethod.CRC32);
