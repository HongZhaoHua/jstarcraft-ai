...
import static orestes.bloomfilter.test.cachesketch.ExpiringTestHelpers.assertBetween;
import static orestes.bloomfilter.test.cachesketch.ExpiringTestHelpers.assertEmpty;
import static orestes.bloomfilter.test.cachesketch.ExpiringTestHelpers.assertGreaterThan;
import static orestes.bloomfilter.test.cachesketch.ExpiringTestHelpers.assertLessThan;
import static orestes.bloomfilter.test.cachesketch.ExpiringTestHelpers.assertRemainingTTL;
import static orestes.bloomfilter.test.cachesketch.ExpiringTestHelpers.assertTimeBetween;
...
public class ExpiringTest {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = { { TYPE_MEMORY_ONLY }, { TYPE_REDIS_MEMORY }, { TYPE_REDIS_ONLY }, };
    ...
    public void testAutoCleanupPeriod() throws Exception {
        FilterBuilder b = new FilterBuilder(100000, 0.05).gracePeriod(2000).cleanupInterval(1000);
        createFilter(b);
    ...
    public void exceedCapacity() {
        ...
        IntStream.range(0, 200).forEach(i -> {
            ...
            // System.out.println(filter.getEstimatedPopulation() + ":" +
