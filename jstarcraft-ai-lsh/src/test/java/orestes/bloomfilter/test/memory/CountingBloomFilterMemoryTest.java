...
import static orestes.bloomfilter.test.helper.Helper.assertAllEqual;
import static orestes.bloomfilter.test.helper.Helper.assertBitsSet;
import static orestes.bloomfilter.test.helper.Helper.configure;
...
public class CountingBloomFilterMemoryTest {
    ...
    public static Collection<Object[]> data() throws Exception {
        Object[][] data = { { 8, CountingBloomFilter8.class }, { 16, CountingBloomFilter16.class }, { 32, CountingBloomFilter32.class }, { 64, CountingBloomFilter64.class }, { 3, CountingBloomFilterMemory.class }, { 7, CountingBloomFilterMemory.class }, { 8, CountingBloomFilterMemory.class }, { 16, CountingBloomFilterMemory.class }, { 32, CountingBloomFilterMemory.class }, { 64, CountingBloomFilterMemory.class }, };
