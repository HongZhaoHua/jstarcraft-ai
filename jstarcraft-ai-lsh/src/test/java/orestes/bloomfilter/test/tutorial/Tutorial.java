...
public class Tutorial {
    ...
    public static void regularBF() {
        // Create a Bloom filter that has a false positive rate of 0.1 when containing
        // 1000 elements
    ...
    public static void countingBF() throws MalformedURLException {
        // Create a Counting Bloom filter that has a FP rate of 0.01 when 1000 are
        // inserted
    ...
    public static void redisBF() {
        ...
        BloomFilter<String> bfr = new FilterBuilder(1000, 0.01).name(filterName) // use a distinct name
        ...
        BloomFilter<String> bfr2 = new FilterBuilder(1000, 0.01).name(filterName) // load the same filter
                .redisBacked(true).buildBloomFilter();
        bfr2.add("bison");
    ...
    public static void customHash() {
        BloomFilter<String> bf = new FilterBuilder(1000, 0.01).hashFunction((value, m, k) -> null).buildBloomFilter();
    }
    ...
    public static void testPerformance() throws UnknownHostException, IOException {
        ...
        CountingBloomFilter<String> first = new FilterBuilder(1000, 0.01).redisBacked(true).buildCountingBloomFilter();
        bfs.add(first);
        for (int i = 1; i < 10; i++) {
            bfs.add(first.clone());
        }
